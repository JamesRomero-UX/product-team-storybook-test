import{g as d}from"./iframe-CGUFCU7f.js";function c(p,s){for(var n=0;n<s.length;n++){const t=s[n];if(typeof t!="string"&&!Array.isArray(t)){for(const e in t)if(e!=="default"&&!(e in p)){const i=Object.getOwnPropertyDescriptor(t,e);i&&Object.defineProperty(p,e,i.get?i:{enumerable:!0,get:()=>t[e]})}}}return Object.freeze(Object.defineProperty(p,Symbol.toStringTag,{value:"Module"}))}var r={exports:{}},$;function a(){return $||($=1,(function(p,s){ace.define("ace/snippets/c_cpp.snippets",["require","exports","module"],function(n,t,e){e.exports=`## STL Collections
# std::array
snippet array
