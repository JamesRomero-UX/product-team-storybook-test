...
import { guidesApiRootPath as a } from "../guide/client.mjs";
const r = "default";
class o {
  constructor(e) {
    i(this, "instance");
  ...
  async markGuideStepAs(e, t) {
    const s = await this.instance.client().makeRequest({
      method: "PUT",
      url: `${a(this.instance.userId)}/messages/${e}`,
      data: t
    });
    return this.handleResponse(s);
  }
  async resetGuideEngagement(e) {
    const t = await this.instance.client().makeRequest({
      method: "PUT",
      url: `${a(this.instance.userId)}/engagements/reset`,
      data: e
    });
    return this.handleResponse(t);
  }
