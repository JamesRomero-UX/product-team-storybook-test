...
import { GuideEngagementEventBaseParams, ResetGuideEngagementParams, ResetGuideEngagementResponse } from '../guide/types';
...
declare class UserClient {
    ...
    resetGuideEngagement(params: ResetGuideEngagementParams): Promise<ResetGuideEngagementResponse>;
