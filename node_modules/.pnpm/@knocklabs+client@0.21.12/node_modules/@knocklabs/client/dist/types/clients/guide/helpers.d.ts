...
export declare const checkStateIfThrottled: (state: StoreState) => boolean;
export declare const newUrl: (location: string) => URL | undefined;
export declare const evaluateUrlRule: (url: URL, urlRule: GuideActivationUrlRuleData) => boolean;
export declare const predicateUrlRules: (url: URL, urlRules: GuideActivationUrlRuleData[]) => boolean | undefined;
export declare const predicateUrlPatterns: (url: URL, urlPatterns: KnockGuideActivationUrlPattern[]) => boolean | undefined;
export type ToolbarV2RunConfig = {
    isVisible: boolean;
    focusedGuideKeys?: Record<KnockGuide["key"], true>;
};
export declare const getToolbarRunConfigFromUrl: () => ToolbarV2RunConfig;
