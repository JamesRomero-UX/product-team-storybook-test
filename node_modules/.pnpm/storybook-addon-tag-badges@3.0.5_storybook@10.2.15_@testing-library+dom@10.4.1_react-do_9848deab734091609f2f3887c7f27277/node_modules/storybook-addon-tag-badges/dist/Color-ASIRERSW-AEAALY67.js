import { __commonJS, __toESM, getControlId } from './chunk-44J4MMB3.js';
...
var useColorInput = (initialValue, onChange) => {
  let [value, setValue] = useState(initialValue || ""), [color, setColor] = useState(() => parseValue(value)), [colorSpace, setColorSpace] = useState(
...
var ColorControl = ({
  ...
  return e.createElement(Wrapper, null, e.createElement("label", { htmlFor: controlId, className: "sb-sr-only" }, name), e.createElement(
    Input,
    {
      id: controlId,
      value,
    ...
    PopoverProvider,
    {
      ...
      popover: e.createElement(TooltipContent, null, e.createElement(
        Picker,
        {
      ...
      ), presets.length > 0 && e.createElement(Swatches, null, presets.map((preset, index) => e.createElement(
        SwatchColor,
        {
    ...
    e.createElement(MarkupIcon, null)
  ) : null);
};
