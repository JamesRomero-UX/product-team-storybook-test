...
function SubItems({ items, expandable, expanded, }) {
    return (React.createElement("ul", { className: clsx(styles['sub-items'], expandable && styles.expandable) }, items.map(({ key, value }, index) => (React.createElement("li", { key: index, className: clsx(styles['inner-list-item'], styles['key-value-pair'], (expanded || !expandable) && screenReaderTextClass) },
...
function NonExpandableSeries({ itemKey, value, subItems, markerType, color }) {
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: clsx(styles['key-value-pair'], screenReaderTextClass) },
