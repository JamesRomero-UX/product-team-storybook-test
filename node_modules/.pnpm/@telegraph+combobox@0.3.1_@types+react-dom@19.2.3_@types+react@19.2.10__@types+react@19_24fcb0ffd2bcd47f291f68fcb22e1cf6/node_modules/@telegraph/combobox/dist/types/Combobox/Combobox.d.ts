...
import { RemappedOmit, TgphComponentProps, TgphElement } from '@telegraph/helpers';
...
export declare const ComboboxContext: React.Context<Omit<RootProps<Option | Option[] | string[], boolean>, "children"> & {
    contentId: string;
    triggerId: string;
    open: boolean;
...
declare const Root: <O extends (Option | Array<Option>) | (string | Array<string>), LB extends boolean>({ modal, closeOnSelect, clearable, disabled, legacyBehavior, open: openProp, onOpenChange: onOpenChangeProp, defaultOpen: defaultOpenProp, value: valueProp, defaultValue: defaultValueProp, onValueChange: onValueChangeProp, errored, placeholder, layout, defaultScrollToValue, children, ...props }: RootProps<O, LB>) => import("react/jsx-runtime").JSX.Element;
...
declare const Create: <T extends TgphElement, LB extends boolean>({ leadingText, values, onCreate, selected, legacyBehavior, ...props }: CreateProps<T, LB>) => import("react/jsx-runtime").JSX.Element | undefined;
