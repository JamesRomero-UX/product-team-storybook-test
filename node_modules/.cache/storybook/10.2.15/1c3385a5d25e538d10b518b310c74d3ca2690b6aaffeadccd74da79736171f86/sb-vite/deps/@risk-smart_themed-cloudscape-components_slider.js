...
import "./chunk-JXM4BF5H.js";
import {
  useUniqueId
} from "./chunk-Z3FGJ2XJ.js";
import "./chunk-4UVHBYQ2.js";
import {
  applyDisplayName,
  getBaseProps,
  useBaseComponent
...
// node_modules/.pnpm/@risk-smart+themed-cloudscape-components@0.1.8_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@risk-smart/themed-cloudscape-components/slider/index.js
var import_react4 = __toESM(require_react());

// node_modules/.pnpm/@risk-smart+themed-cloudscape-components@0.1.8_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@risk-smart/themed-cloudscape-components/slider/internal.js
var import_react3 = __toESM(require_react());

// node_modules/.pnpm/@risk-smart+themed-cloudscape-components@0.1.8_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@risk-smart/themed-cloudscape-components/slider/slider-labels.js
var import_react = __toESM(require_react());

// node_modules/.pnpm/@risk-smart+themed-cloudscape-components@0.1.8_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@risk-smart/themed-cloudscape-components/slider/styles.css.js
import "/Users/jamesromero/Library/CloudStorage/OneDrive-RiskSmart/Product - Product Dream Team/Product-team-storybook/node_modules/.pnpm/@risk-smart+themed-cloudscape-components@0.1.8_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@risk-smart/themed-cloudscape-components/slider/styles.scoped.css";
var styles_css_default = {
  "root": "awsui_root_pcgz5_16aai_153",
  "slider": "awsui_slider_pcgz5_16aai_190",
  "slider-track": "awsui_slider-track_pcgz5_16aai_194",
  "slider-range": "awsui_slider-range_pcgz5_16aai_194",
  "disabled": "awsui_disabled_pcgz5_16aai_209",
  "readonly": "awsui_readonly_pcgz5_16aai_213",
  "error": "awsui_error_pcgz5_16aai_222",
  "warning": "awsui_warning_pcgz5_16aai_225",
  "active": "awsui_active_pcgz5_16aai_228",
  "error-active": "awsui_error-active_pcgz5_16aai_231",
  "warning-active": "awsui_warning-active_pcgz5_16aai_234",
  "labels": "awsui_labels_pcgz5_16aai_245",
  "labels-noref": "awsui_labels-noref_pcgz5_16aai_251",
  "labels-reference": "awsui_labels-reference_pcgz5_16aai_254",
  "labels-min": "awsui_labels-min_pcgz5_16aai_261",
  "labels-max": "awsui_labels-max_pcgz5_16aai_267",
  "labels-aria-description": "awsui_labels-aria-description_pcgz5_16aai_275",
  "ticks": "awsui_ticks_pcgz5_16aai_293",
  "ticks-wrapper": "awsui_ticks-wrapper_pcgz5_16aai_299",
  "tick": "awsui_tick_pcgz5_16aai_293",
  "middle": "awsui_middle_pcgz5_16aai_314",
  "filled": "awsui_filled_pcgz5_16aai_317",
  "tooltip-thumb": "awsui_tooltip-thumb_pcgz5_16aai_345",
  "thumb": "awsui_thumb_pcgz5_16aai_358",
  "min": "awsui_min_pcgz5_16aai_394",
  "max": "awsui_max_pcgz5_16aai_397"
};
...
function SliderLabels({ min, max, referenceValues, valueFormatter, labelsId, ariaDescription }) {
  ...
  return import_react.default.createElement(
    ...
    import_react.default.createElement(
      "div",
      { role: "list", "aria-hidden": !valueFormatter && !referenceValues ? "true" : void 0, className: clsx_default(styles_css_default.labels, {
      ...
      import_react.default.createElement("span", { role: "listitem", className: clsx_default(styles_css_default.label, styles_css_default["labels-min"]), style: {
      ...
      getVisibleReferenceValues().map((step) => {
        ...
        }, className: clsx_default(styles_css_default.label, styles_css_default["labels-reference"]) }, valueFormatter ? valueFormatter(step) : step);
      }),
      import_react.default.createElement("span", { role: "listitem", className: clsx_default(styles_css_default.label, styles_css_default["labels-max"]), style: {
...
// node_modules/.pnpm/@risk-smart+themed-cloudscape-components@0.1.8_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@risk-smart/themed-cloudscape-components/slider/tick-marks.js
var import_react2 = __toESM(require_react());

// node_modules/.pnpm/@risk-smart+themed-cloudscape-components@0.1.8_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@risk-smart/themed-cloudscape-components/slider/utils.js
...
function TickMark(props) {
  ...
  return import_react2.default.createElement("div", { className: clsx_default(styles_css_default.tick, {
...
function InternalSlider(_a) {
  ...
  return import_react3.default.createElement(
    "div",
    Object.assign({}, baseProps, { ref: __internalRootRef, className: clsx_default(baseProps.className, styles_css_default.root) }),
    import_react3.default.createElement(
      ...
      showTooltip && import_react3.default.createElement(Tooltip, { value: valueFormatter ? valueFormatter(sliderValue) : sliderValue, trackRef: handleRef, onDismiss: () => setShowTooltip(false) }),
      import_react3.default.createElement("div", { ref: handleRef, className: clsx_default(styles_css_default["tooltip-thumb"], {
        [styles_css_default.readonly]: readOnly
      }), style: {
      ...
      import_react3.default.createElement(
        ...
        import_react3.default.createElement("div", { className: clsx_default(styles_css_default["slider-track"], {
          [styles_css_default.disabled]: disabled,
          [styles_css_default.readonly]: readOnly
        }) }),
        !hideFillLine && import_react3.default.createElement("div", { className: clsx_default(styles_css_default["slider-range"], {
      ...
      import_react3.default.createElement("input", {
        ...
        className: clsx_default(styles_css_default.thumb, {
          [styles_css_default.error]: invalid,
          [styles_css_default.warning]: showWarning,
          [styles_css_default.disabled]: disabled,
          [styles_css_default.readonly]: readOnly,
...
//# sourceMappingURL=@risk-smart_themed-cloudscape-components_slider.js.map
