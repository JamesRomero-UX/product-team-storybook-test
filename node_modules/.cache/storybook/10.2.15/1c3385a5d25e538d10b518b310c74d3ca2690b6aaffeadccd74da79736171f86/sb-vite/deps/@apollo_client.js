...
} from "./chunk-5JWYMJVH.js";
import "./chunk-Z2JV7YJF.js";
import {
  __assign,
  __rest,
  __spreadArray
} from "./chunk-XSNQIJR6.js";
import "./chunk-YHCPMRL2.js";
import {
  __toESM
} from "./chunk-PR4QN5HX.js";

// node_modules/.pnpm/@apollo+client@3.13.9_@types+react@19.2.10_graphql@16.13.2_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@apollo/client/react/hooks/useApolloClient.js
...
// node_modules/.pnpm/@apollo+client@3.13.9_@types+react@19.2.10_graphql@16.13.2_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@apollo/client/react/hooks/useLazyQuery.js
var React8 = __toESM(require_rehackt(), 1);

// node_modules/.pnpm/@apollo+client@3.13.9_@types+react@19.2.10_graphql@16.13.2_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@apollo/client/react/hooks/useQuery.js
var React7 = __toESM(require_rehackt(), 1);

// node_modules/.pnpm/@apollo+client@3.13.9_@types+react@19.2.10_graphql@16.13.2_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@apollo/client/react/hooks/useSyncExternalStore.js
...
// node_modules/.pnpm/@apollo+client@3.13.9_@types+react@19.2.10_graphql@16.13.2_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@apollo/client/react/parser/index.js
var DocumentType;
...
// node_modules/.pnpm/@apollo+client@3.13.9_@types+react@19.2.10_graphql@16.13.2_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@apollo/client/react/hooks/internal/useDeepMemo.js
...
// node_modules/.pnpm/@apollo+client@3.13.9_@types+react@19.2.10_graphql@16.13.2_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@apollo/client/react/hooks/internal/useIsomorphicLayoutEffect.js
var React4 = __toESM(require_rehackt(), 1);
var useIsomorphicLayoutEffect = canUseDOM ? React4.useLayoutEffect : React4.useEffect;

// node_modules/.pnpm/@apollo+client@3.13.9_@types+react@19.2.10_graphql@16.13.2_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@apollo/client/react/hooks/internal/useRenderGuard.js
...
// node_modules/.pnpm/@apollo+client@3.13.9_@types+react@19.2.10_graphql@16.13.2_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@apollo/client/react/hooks/internal/__use.js
var React6 = __toESM(require_rehackt(), 1);
var useKey = "use";
var realHook2 = React6[useKey];
...
// node_modules/.pnpm/@apollo+client@3.13.9_@types+react@19.2.10_graphql@16.13.2_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@apollo/client/react/hooks/internal/wrapHook.js
...
function useInternalState(client, query, options, renderPromises, makeWatchQueryOptions) {
  ...
  var _a = React7.useState(createInternalState), internalState = _a[0], updateInternalState = _a[1];
...
function useQueryInternals(query, options) {
  ...
  var renderPromises = React7.useContext(getApolloContext()).renderPromises;
  ...
  var obsQueryFields = React7.useMemo(function() {
...
function useObservableSubscriptionResult(resultData, observable, client, options, watchQueryOptions, disableNetworkFetches, partialRefetch, isSyncSSR, callbacks) {
  var callbackRef = React7.useRef(callbacks);
  ...
  var currentResultOverride = React7.useMemo(function() {
    return resultOverride && toQueryResult(resultOverride, previousData, observable, client);
  }, [client, observable, resultOverride, previousData]);
  return useSyncExternalStore(React7.useCallback(function(handleStoreChange) {
...
function useLazyQuery(query, options) {
  var _a;
  var execOptionsRef = React8.useRef(void 0);
  var optionsRef = React8.useRef(void 0);
  var queryRef = React8.useRef(void 0);
  ...
  var forceUpdateState = React8.useReducer(function(tick) {
    return tick + 1;
  }, 0)[1];
  var eagerMethods = React8.useMemo(function() {
    var eagerMethods2 = {};
  ...
  var result = React8.useMemo(function() {
  ...
  var executeRef = React8.useRef(execute2);
  useIsomorphicLayoutEffect(function() {
    executeRef.current = execute2;
  });
  var stableExecute = React8.useCallback(function() {
    var args = [];
...
// node_modules/.pnpm/@apollo+client@3.13.9_@types+react@19.2.10_graphql@16.13.2_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@apollo/client/react/hooks/useMutation.js
...
function useMutation(mutation, options) {
  ...
  var reset = React9.useCallback(function() {
...
// node_modules/.pnpm/@apollo+client@3.13.9_@types+react@19.2.10_graphql@16.13.2_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@apollo/client/react/hooks/useSubscription.js
var React10 = __toESM(require_rehackt(), 1);
function useSubscription(subscription, options) {
  if (options === void 0) {
    options = /* @__PURE__ */ Object.create(null);
  }
  var hasIssuedDeprecationWarningRef = React10.useRef(false);
  var client = useApolloClient(options.client);
  ...
  var _a = React10.useState(options.skip ? null : recreate), observable = _a[0], setObservable = _a[1];
  var recreateRef = React10.useRef(recreate);
  useIsomorphicLayoutEffect(function() {
  ...
  var optionsRef = React10.useRef(options);
  React10.useEffect(function() {
    optionsRef.current = options;
  });
  var fallbackLoading = !skip && !ignoreResults;
  var fallbackResult = React10.useMemo(function() {
    return {
  ...
  var ignoreResultsRef = React10.useRef(ignoreResults);
  useIsomorphicLayoutEffect(function() {
    ignoreResultsRef.current = ignoreResults;
  });
  var ret = useSyncExternalStore(React10.useCallback(function(update) {
    if (!observable) {
      return function() {
      };
    }
  ...
  var restart = React10.useCallback(function() {
...
// node_modules/.pnpm/@apollo+client@3.13.9_@types+react@19.2.10_graphql@16.13.2_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@apollo/client/react/hooks/useReactiveVar.js
var React11 = __toESM(require_rehackt(), 1);
function useReactiveVar(rv) {
  return useSyncExternalStore(React11.useCallback(function(update) {
...
// node_modules/.pnpm/@apollo+client@3.13.9_@types+react@19.2.10_graphql@16.13.2_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@apollo/client/react/hooks/useFragment.js
...
function useFragment_(options) {
  ...
  var id = React12.useMemo(function() {
  ...
  var diff = React12.useMemo(function() {
  ...
  var getSnapshot = React12.useCallback(function() {
    return diff.result;
  }, [diff]);
  return useSyncExternalStore(React12.useCallback(function(forceUpdate) {
    var lastTimeout = 0;
...
// node_modules/.pnpm/@apollo+client@3.13.9_@types+react@19.2.10_graphql@16.13.2_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@apollo/client/react/hooks/useSuspenseQuery.js
var React13 = __toESM(require_rehackt(), 1);

// node_modules/.pnpm/@apollo+client@3.13.9_@types+react@19.2.10_graphql@16.13.2_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@apollo/client/react/internal/cache/QueryReference.js
...
// node_modules/.pnpm/@apollo+client@3.13.9_@types+react@19.2.10_graphql@16.13.2_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@apollo/client/react/internal/cache/FragmentReference.js
...
// node_modules/.pnpm/@apollo+client@3.13.9_@types+react@19.2.10_graphql@16.13.2_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@apollo/client/react/internal/cache/SuspenseCache.js
var SuspenseCache = (
  /** @class */
  (function() {
...
// node_modules/.pnpm/@apollo+client@3.13.9_@types+react@19.2.10_graphql@16.13.2_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@apollo/client/react/internal/cache/getSuspenseCache.js
...
// node_modules/.pnpm/@apollo+client@3.13.9_@types+react@19.2.10_graphql@16.13.2_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@apollo/client/react/hooks/constants.js
...
function useSuspenseQuery_(query, options) {
  ...
  var _b = React13.useState([queryRef.key, queryRef.promise]), current = _b[0], setPromise = _b[1];
  ...
  var skipResult = React13.useMemo(function() {
  ...
  var fetchMore = React13.useCallback(function(options2) {
    var promise2 = queryRef.fetchMore(options2);
    setPromise([queryRef.key, queryRef.promise]);
    return promise2;
  }, [queryRef]);
  var refetch = React13.useCallback(function(variables2) {
...
// node_modules/.pnpm/@apollo+client@3.13.9_@types+react@19.2.10_graphql@16.13.2_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@apollo/client/react/hooks/useBackgroundQuery.js
...
function useBackgroundQuery_(query, options) {
  ...
  var fetchPolicy = watchQueryOptions.fetchPolicy, variables = watchQueryOptions.variables;
  var _a = options.queryKey, queryKey = _a === void 0 ? [] : _a;
  var didFetchResult = React14.useRef(fetchPolicy !== "standby");
  ...
  var _b = React14.useState(wrapQueryRef(queryRef)), wrappedQueryRef = _b[0], setWrappedQueryRef = _b[1];
...
// node_modules/.pnpm/@apollo+client@3.13.9_@types+react@19.2.10_graphql@16.13.2_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@apollo/client/react/hooks/useSuspenseFragment.js
...
function useSuspenseFragment_(options) {
  ...
  var _a = React15.useState(fragmentRef === null ? NULL_PLACEHOLDER : [fragmentRef.key, fragmentRef.promise]), current = _a[0], setPromise = _a[1];
...
// node_modules/.pnpm/@apollo+client@3.13.9_@types+react@19.2.10_graphql@16.13.2_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@apollo/client/react/hooks/useLoadableQuery.js
...
// node_modules/.pnpm/@apollo+client@3.13.9_@types+react@19.2.10_graphql@16.13.2_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@apollo/client/react/hooks/useQueryRefHandlers.js
...
// node_modules/.pnpm/@apollo+client@3.13.9_@types+react@19.2.10_graphql@16.13.2_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@apollo/client/react/hooks/useReadQuery.js
...
// node_modules/.pnpm/@apollo+client@3.13.9_@types+react@19.2.10_graphql@16.13.2_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@apollo/client/react/query-preloader/createQueryPreloader.js
