...
// node_modules/.pnpm/highcharts@12.5.0/node_modules/highcharts/modules/exporting.js
var require_exporting = __commonJS({
  "node_modules/.pnpm/highcharts@12.5.0/node_modules/highcharts/modules/exporting.js"(exports, module) {
    !/**
    ...
    */
    (function(e, t) {
      ...
      D.post = async function(e2, t2, n2) {
        let i2 = new L.FormData();
        A(t2, function(e3, t3) {
          i2.append(t3, e3);
        }), i2.append("b64", "true");
        let o2 = await L.fetch(e2, { method: "POST", body: i2, ...n2 });
        if (o2.ok) {
      ...
      class eh {
        ...
        static async imageToDataURL(e2, t2, n2) {
          let i2 = await eh.loadImage(e2), o2 = B.createElement("canvas"), r2 = o2?.getContext("2d");
        ...
        static prepareImageOptions(e2) {
          ...
          return { type: t2, filename: (e2?.filename || "chart") + "." + ("image/svg+xml" === t2 ? "svg" : t2.split("/")[1]), scale: e2?.scale || 1, libURL: n2?.slice(-1) !== "/" ? n2 + "/" : n2 };
        }
        ...
        contextMenu(e2, t2, n2, i2, o2, r2, a2) {
          ...
          m2 || (s2.contextMenuEl = l2[u2] = m2 = J("div", { className: e2 }, { position: "absolute", zIndex: 1e3, padding: g2 + "px", pointerEvents: "auto", ...l2.renderer.style }, l2.scrollablePlotArea?.fixedDiv || l2.container), f2 = J("ul", { className: "highcharts-menu" }, l2.styledMode ? {} : { listStyle: "none", margin: 0, padding: 0 }, m2), l2.styledMode || _(f2, Z({ MozBoxShadow: "3px 3px 10px #0008", WebkitBoxShadow: "3px 3px 10px #0008", boxShadow: "3px 3px 10px #0008" }, c2?.menuStyle || {})), m2.hideMenu = function() {
            ...
            if ("string" == typeof e3 && s2.options.menuItemDefinitions?.[e3] && (e3 = s2.options.menuItemDefinitions[e3]), et(e3, true)) {
              ...
              }, _(t3, Z({ cursor: "pointer" }, c2?.menuItemStyle || {})))), s2.divElements.push(t3);
            }
          }), s2.divElements.push(f2, m2), s2.menuHeight = m2.offsetHeight, s2.menuWidth = m2.offsetWidth);
          let y2 = { display: "block" };
          n2 + (s2.menuWidth || 0) > h2 ? y2.right = h2 - n2 - o2 - g2 + "px" : y2.left = n2 - g2 + "px", i2 + r2 + (s2.menuHeight || 0) > p2 && a2.alignOptions?.verticalAlign !== "top" ? y2.bottom = p2 - i2 - g2 + "px" : y2.top = i2 + r2 - g2 + "px", _(m2, y2), _(l2.renderTo, { overflow: "" }), _(l2.container, { overflow: "" }), l2.exporting && (l2.exporting.openMenu = true), ee(l2, "exportMenuShown");
        }
        destroy(e2) {
            ...
            try {
              ...
              if (n3 && i3 && c2) {
                ...
                if (t3.width = h3, t3.height = p2, !q.canvg) {
                  var l2;
                  eh.objectURLRevoke = true, await (l2 = s2 + "canvg.js", new Promise((e3, t4) => {
        ...
        async exportChart(e2, t2) {
          if ((e2 = en(this.options, e2)).local) await this.localExport(e2, t2 || {});
            ...
            e2.url && await D.post(e2.url, { filename: e2.filename ? e2.filename.replace(/\//g, "-") : this.getFilename(), type: e2.type, width: e2.width, scale: e2.scale, svg: n2 }, e2.fetchOptions);
          }
        }
        ...
        getSVG(e2) {
          ...
          let r2 = J("div", void 0, { position: "absolute", top: "-9999em", width: t2.chartWidth + "px", height: t2.chartHeight + "px" }, B.body), a2 = t2.renderTo.style.width, s2 = t2.renderTo.style.height, l2 = o2.exporting?.sourceWidth || o2.chart.width || /px$/.test(a2) && parseInt(a2, 10) || (o2.isGantt ? 800 : 600), c2 = o2.exporting?.sourceHeight || o2.chart.height || /px$/.test(s2) && parseInt(s2, 10) || 400;
          Z(o2.chart, { animation: false, renderTo: r2, forExport: true, renderer: "SVGRenderer", width: l2, height: c2 }), o2.exporting && (o2.exporting.enabled = false), delete o2.data, o2.series = [], t2.series.forEach(function(e3) {
            (i2 = en(e3.userOptions, { animation: false, enableMouseTracking: false, showCheckbox: false, visible: e3.visible })).isInternal || o2?.series?.push(i2);
          });
          let h2 = {};
          ...
          }), n2 = p2.exporting?.getChartHTML(t2.styledMode || o2.exporting?.applyStyleSheets) || "", ee(t2, "getSVG", { chartCopy: p2 }), n2 = eh.sanitizeSVG(n2, o2), o2 = void 0, p2.destroy(), X(r2), n2;
        }
        getSVGForExport(e2, t2) {
          let n2 = this.options;
          return this.getSVG(en({ chart: { borderRadius: 0 } }, n2.chartOptions, t2, { exporting: { sourceWidth: e2?.sourceWidth || n2.sourceWidth, sourceHeight: e2?.sourceHeight || n2.sourceHeight } }));
        }
        inlineStyles() {
          let e2, t2 = eh.inlineDenylist, n2 = eh.inlineAllowlist, i2 = {}, o2 = J("iframe", void 0, { width: "1px", height: "1px", visibility: "hidden" }, B.body), r2 = o2.contentWindow?.document;
        ...
        async localExport(e2, t2) {
          ...
          try {
            ...
            for (let n4 of (this.getSVGForExport(e2, t2), a2 ? Array.from(a2) : [])) if (r2 = n4.getAttributeNS("http://www.w3.org/1999/xlink", "href")) {
              ...
              let t3 = await eh.imageToDataURL(r2, e2?.scale || 1, e2?.type || "image/png");
              n4.setAttributeNS("http://www.w3.org/1999/xlink", "href", t3);
            } else n4.parentNode.removeChild(n4);
            let s3 = i2?.querySelector("svg");
            s3 && !e2.chartOptions?.chart?.style?.fontFamily && await eh.inlineFonts(s3);
        ...
        render() {
          let e2 = this, { chart: t2, options: n2 } = e2, i2 = e2?.isDirty || !e2?.svgElements.length;
          e2.buttonOffset = 0, e2.isDirty && e2.destroy(), i2 && false !== n2.enabled && (e2.events = [], e2.group || (e2.group = t2.renderer.g("exporting-group").attr({ zIndex: 3 }).add()), ei(n2?.buttons, function(t3) {
            e2.addButton(t3);
          }), e2.isDirty = false);
        }
        resolveCSSVariables() {
      ...
      eh.inlineAllowlist = [], eh.inlineDenylist = [/-/, /^(clipPath|cssText|d|height|width)$/, /^font$/, /[lL]ogical(Width|Height)$/, /^parentRule$/, /^(cssRules|ownerRules)$/, /perspective/, /TapHighlightColor/, /^transition/, /^length$/, /^\d+$/], eh.inlineToAttributes = ["fill", "stroke", "strokeLinecap", "strokeLinejoin", "strokeWidth", "textAnchor", "x", "y"], eh.loadEventDeferDelay = 150 * !!$, eh.unstyledElements = ["clipPath", "defs", "desc"], (function(e2) {
        ...
        function i2({ alignTo: e3, key: t3, textPxLength: n3 }) {
          let i3 = this.options.exporting, { align: o2, buttonSpacing: r2 = 0, verticalAlign: a2, width: s2 = 0 } = en(this.options.navigation?.buttonOptions, i3?.buttons?.contextButton), l2 = e3.width - n3, c2 = s2 + r2;
        ...
        e2.compose = function(o2, r2) {
          T.compose(r2), H.compose(o2), er(j, "Exporting") && (Z(g().prototype, { exportChart: async function(e3, t3) {
            await this.exporting?.exportChart(e3, t3);
