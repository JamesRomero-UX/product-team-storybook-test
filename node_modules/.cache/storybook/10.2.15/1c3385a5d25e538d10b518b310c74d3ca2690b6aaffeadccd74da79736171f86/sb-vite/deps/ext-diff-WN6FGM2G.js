...
// node_modules/.pnpm/ace-builds@1.43.6/node_modules/ace-builds/src-noconflict/ext-diff.js
var require_ext_diff = __commonJS({
  "node_modules/.pnpm/ace-builds@1.43.6/node_modules/ace-builds/src-noconflict/ext-diff.js"(exports, module) {
    ace.define("ace/ext/diff/scroll_diff_decorator", ["require", "exports", "module", "ace/layer/decorators"], function(require2, exports2, module2) {
      ...
      var ScrollDiffDecorator = (
        /** @class */
        (function(_super) {
          __extends(ScrollDiffDecorator2, _super);
          function ScrollDiffDecorator2(scrollbarV, renderer, forInlineDiff) {
          ...
          ScrollDiffDecorator2.prototype.addZone = function(startRow, endRow, type) {
            this.$zones.push({
              startRow,
              endRow,
              type
          ...
          ScrollDiffDecorator2.prototype.setSessions = function(sessionA, sessionB) {
            this.sessionA = sessionA;
            this.sessionB = sessionB;
          };
          ScrollDiffDecorator2.prototype.$updateDecorators = function(config) {
          ...
          ScrollDiffDecorator2.prototype.$transformPosition = function(row, type) {
            if (type == "delete") {
          ...
          ScrollDiffDecorator2.prototype.$setDiffDecorators = function(ctx, colors) {
            var e_1, _a;
            var _this = this;
            ...
            if (zones) {
              ...
              [deleteZones, insertZones].forEach(function(typeZones) {
                typeZones.forEach(function(zone2, i) {
                  var offset1 = _this.$transformPosition(zone2.startRow, zone2.type) * _this.lineHeight;
                  var offset2 = _this.$transformPosition(zone2.endRow, zone2.type) * _this.lineHeight + _this.lineHeight;
                  ...
                  if (i > 0 && previousZone && previousZone.type === zone2.type && ycenter - halfHeight < previousZone.to + padding) {
          ...
          ScrollDiffDecorator2.prototype.setZoneWidth = function() {
            this.oneZoneWidth = Math.round(this.canvasWidth / 3);
          };
          return ScrollDiffDecorator2;
        })(Decorator)
      );
      exports2.ScrollDiffDecorator = ScrollDiffDecorator;
    });
    ace.define("ace/ext/diff/styles-css.js", ["require", "exports", "module"], function(require2, exports2, module2) {
    ...
    ace.define("ace/ext/diff/gutter_decorator", ["require", "exports", "module", "ace/lib/dom"], function(require2, exports2, module2) {
      var dom = require2("../../lib/dom");
      var MinimalGutterDiffDecorator = (
        /** @class */
        (function() {
          function MinimalGutterDiffDecorator2(editor, type) {
          ...
          MinimalGutterDiffDecorator2.prototype.attachToEditor = function() {
          ...
          MinimalGutterDiffDecorator2.prototype.renderGutters = function(e, gutterLayer) {
            var _this = this;
          ...
          MinimalGutterDiffDecorator2.prototype.setDecorations = function(changes) {
            this.chunks = changes;
            this.renderGutters();
          };
          MinimalGutterDiffDecorator2.prototype.dispose = function() {
    ...
    ace.define("ace/ext/diff/base_diff_view", ["require", "exports", "module", "ace/lib/oop", "ace/range", "ace/lib/dom", "ace/config", "ace/line_widgets", "ace/ext/diff/scroll_diff_decorator", "ace/ext/diff/styles-css.js", "ace/editor", "ace/virtual_renderer", "ace/undomanager", "ace/layer/decorators", "ace/theme/textmate", "ace/multi_select", "ace/edit_session", "ace/ext/diff/gutter_decorator"], function(require2, exports2, module2) {
      ...
      var ScrollDiffDecorator = require2("./scroll_diff_decorator").ScrollDiffDecorator;
      var css = require2("./styles-css.js").cssText;
      ...
      var MinimalGutterDiffDecorator = require2("./gutter_decorator").MinimalGutterDiffDecorator;
      ...
      var BaseDiffView = (
        /** @class */
        (function() {
          function BaseDiffView2(inlineDiffEditor, container) {
          ...
          BaseDiffView2.prototype.$setupModels = function(diffModel) {
            ...
            var diffEditorOptions = (
              /**@type {Partial<import("../../../ace-internal").Ace.EditorOptions>}*/
              {
                scrollPastEnd: 0.5,
            ...
            if (this.inlineDiffEditor) {
              ...
              this.otherEditor = new Editor(new Renderer(null), void 0, cloneOptions);
              if (this.showSideA) {
          ...
          BaseDiffView2.prototype.addGutterDecorators = function() {
          ...
          BaseDiffView2.prototype.$setupModel = function(session, value) {
          ...
          BaseDiffView2.prototype.foldUnchanged = function() {
          ...
          BaseDiffView2.prototype.unfoldUnchanged = function() {
          ...
          BaseDiffView2.prototype.toggleFoldUnchanged = function() {
            if (!this.foldUnchanged()) {
              this.unfoldUnchanged();
            }
          };
          BaseDiffView2.prototype.setDiffSession = function(session) {
            if (this.diffSession) {
          ...
          BaseDiffView2.prototype.$attachSessionsEventHandlers = function() {
          };
          BaseDiffView2.prototype.$detachSessionsEventHandlers = function() {
          };
          BaseDiffView2.prototype.getDiffSession = function() {
            return this.diffSession;
          };
          BaseDiffView2.prototype.setTheme = function(theme) {
            this.editorA && this.editorA.setTheme(theme);
            this.editorB && this.editorB.setTheme(theme);
          };
          BaseDiffView2.prototype.getTheme = function() {
            return (this.editorA || this.editorB).getTheme();
          };
          BaseDiffView2.prototype.onChangeTheme = function(e) {
          ...
          BaseDiffView2.prototype.resize = function(force) {
            this.editorA && this.editorA.resize(force);
            this.editorB && this.editorB.resize(force);
          };
          BaseDiffView2.prototype.scheduleOnInput = function() {
            var _this = this;
          ...
          BaseDiffView2.prototype.onInput = function() {
            var _this = this;
            if (this.$onInputTimer)
          ...
          BaseDiffView2.prototype.setupScrollbars = function() {
            var _this = this;
          ...
          BaseDiffView2.prototype.$setScrollBarDecorators = function(renderer) {
          ...
          BaseDiffView2.prototype.$resetDecorators = function(renderer) {
            if (renderer.$scrollDecorator) {
              renderer.$scrollDecorator.destroy();
            }
            renderer.$scrollDecorator = new Decorator(renderer.scrollBarV, renderer);
          };
          BaseDiffView2.prototype.updateScrollBarDecorators = function() {
            var _this = this;
            if (this.inlineDiffEditor) {
          ...
          BaseDiffView2.prototype.$diffLines = function(val1, val2) {
          ...
          BaseDiffView2.prototype.setProvider = function(provider) {
            this.diffProvider = provider;
          };
          BaseDiffView2.prototype.$addWidget = function(session, w) {
          ...
          BaseDiffView2.prototype.$initWidgets = function(editor) {
          ...
          BaseDiffView2.prototype.$screenRow = function(pos, session) {
          ...
          BaseDiffView2.prototype.align = function() {
          };
          BaseDiffView2.prototype.onChangeWrapLimit = function(e, session) {
          };
          BaseDiffView2.prototype.onSelect = function(e, selection) {
            this.searchHighlight(selection);
            this.syncSelect(selection);
          };
          BaseDiffView2.prototype.syncSelect = function(selection) {
          ...
          BaseDiffView2.prototype.updateSelectionMarker = function(marker, session, range) {
            marker.setRange(range);
            session._signal("changeFrontMarker");
          };
          BaseDiffView2.prototype.onChangeFold = function(ev, session) {
            var fold = ev.data;
          ...
          BaseDiffView2.prototype.scheduleRealign = function() {
          ...
          BaseDiffView2.prototype.realign = function() {
            this.realignPending = true;
          ...
          BaseDiffView2.prototype.detach = function() {
            if (!this.editorA || !this.editorB)
              return;
          ...
          BaseDiffView2.prototype.$removeLineWidgets = function(session) {
            session.lineWidgets = [];
            session.widgetManager.lineWidgets = [];
            session._signal("changeFold", { data: { start: { row: 0 } } });
          };
          BaseDiffView2.prototype.$detachEventHandlers = function() {
          };
          BaseDiffView2.prototype.destroy = function() {
            this.detach();
            this.editorA && this.editorA.destroy();
            this.editorB && this.editorB.destroy();
            this.editorA = this.editorB = null;
          };
          BaseDiffView2.prototype.gotoNext = function(dir) {
            var ace2 = this.activeEditor || this.editorA;
            if (this.inlineDiffEditor) {
              ace2 = this.editorA;
            }
            var sideA = ace2 == this.editorA;
            var row = ace2.selection.lead.row;
            var i = this.findChunkIndex(this.chunks, row, sideA);
            var chunk = this.chunks[i + dir] || this.chunks[i];
            var scrollTop = ace2.session.getScrollTop();
            if (chunk) {
              var range = chunk[sideA ? "old" : "new"];
              var line = Math.max(range.start.row, range.end.row - 1);
              ace2.selection.setRange(new Range(line, 0, line, 0));
            }
            ace2.renderer.scrollSelectionIntoView(ace2.selection.lead, ace2.selection.anchor, 0.5);
            ace2.renderer.animateScrolling(scrollTop);
          };
          BaseDiffView2.prototype.firstDiffSelected = function() {
            return this.currentDiffIndex <= 1;
          };
          BaseDiffView2.prototype.lastDiffSelected = function() {
            return this.currentDiffIndex > this.chunks.length - 1;
          };
          BaseDiffView2.prototype.transformRange = function(range, isOriginal) {
            return Range.fromPoints(this.transformPosition(range.start, isOriginal), this.transformPosition(range.end, isOriginal));
          };
          BaseDiffView2.prototype.transformPosition = function(pos, isOriginal) {
          ...
          BaseDiffView2.prototype.$getDeltaIndent = function(fromEditSession, toEditSession, fromLine, toLine) {
          ...
          BaseDiffView2.prototype.$getIndent = function(editSession, line) {
            return editSession.getLine(line).match(/^\s*/)[0].length;
          };
          BaseDiffView2.prototype.printDiffs = function() {
            this.chunks.forEach(function(diff) {
              console.log(diff.toString());
            });
          };
          BaseDiffView2.prototype.findChunkIndex = function(chunks, row, isOriginal) {
          ...
          BaseDiffView2.prototype.searchHighlight = function(selection) {
          ...
          BaseDiffView2.prototype.initSelectionMarkers = function() {
      ...
      exports2.BaseDiffView = BaseDiffView;
      var DiffChunk = (
        /** @class */
        /* @__PURE__ */ (function() {
          function DiffChunk2(originalRange, modifiedRange, charChanges) {
            this.old = originalRange;
            this.new = modifiedRange;
            this.charChanges = charChanges && charChanges.map(function(m) {
              return new DiffChunk2(new Range(m.originalStartLineNumber, m.originalStartColumn, m.originalEndLineNumber, m.originalEndColumn), new Range(m.modifiedStartLineNumber, m.modifiedStartColumn, m.modifiedEndLineNumber, m.modifiedEndColumn));
            });
          }
          return DiffChunk2;
        })()
      ...
      var DiffHighlight = (
        /** @class */
        (function() {
          function DiffHighlight2(diffView, type) {
            this.id;
            this.diffView = diffView;
            this.type = type;
          }
          DiffHighlight2.prototype.update = function(html, markerLayer, session, config2) {
            ...
            if (session.lineWidgets && !diffView.inlineDiffEditor) {
              for (var row = config2.firstRow; row <= config2.lastRow; row++) {
                ...
                if (lineWidget.rowsAbove > 0) {
                  ...
                  markerLayer.drawFullLineMarker(html, range, "ace_diff aligned_diff", config2);
                }
            ...
            lineChanges.forEach(function(lineChange) {
              ...
              if (endRow < config2.firstRow || startRow > config2.lastRow)
                return;
              var range2 = new Range(startRow, 0, endRow - 1, 1 << 30);
              if (startRow !== endRow) {
                range2 = range2.toScreenRange(session);
                markerLayer.drawFullLineMarker(html, range2, "ace_diff " + operation, config2);
              }
                ...
                for (var i = 0; i < lineChange.charChanges.length; i++) {
                  ...
                  if (ignoreTrimWhitespace) {
                    for (var lineNumber = changeRange.start.row; lineNumber <= changeRange.end.row; lineNumber++) {
                      ...
                      markerLayer.drawSingleLineMarker(html, screenRange, "ace_diff " + cssClass, config2);
                    }
                  } else {
                    ...
                    if (screenRange.isMultiLine()) {
                      markerLayer.drawTextMarker(html, screenRange, "ace_diff " + cssClass, config2);
                    } else {
                      markerLayer.drawSingleLineMarker(html, screenRange, "ace_diff " + cssClass, config2);
                    }
                  }
          ...
          return DiffHighlight2;
        })()
      );
      var SyncSelectionMarker = (
        /** @class */
        (function() {
          function SyncSelectionMarker2() {
            this.id;
            this.type = "fullLine";
            this.clazz = "ace_diff-active-line";
          }
          SyncSelectionMarker2.prototype.update = function(html, markerLayer, session, config2) {
          };
          SyncSelectionMarker2.prototype.setRange = function(range) {
            var newRange = range.clone();
            newRange.end.column++;
            this.range = newRange;
          };
          return SyncSelectionMarker2;
        })()
      );
      exports2.DiffChunk = DiffChunk;
      exports2.DiffHighlight = DiffHighlight;
    });
    ace.define("ace/ext/diff/inline_diff_view", ["require", "exports", "module", "ace/ext/diff/base_diff_view", "ace/virtual_renderer", "ace/config"], function(require2, exports2, module2) {
      "use strict";
      var __extends = this && this.__extends || /* @__PURE__ */ (function() {
        var extendStatics = function(d, b) {
          extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
      ...
      var BaseDiffView = require2("./base_diff_view").BaseDiffView;
      var Renderer = require2("../../virtual_renderer").VirtualRenderer;
      var config = require2("../../config");
      var InlineDiffView = (
        /** @class */
        (function(_super) {
          __extends(InlineDiffView2, _super);
          function InlineDiffView2(diffModel, container) {
            var _this = this;
            diffModel = diffModel || {};
          ...
          InlineDiffView2.prototype.init = function(diffModel) {
            this.onSelect = this.onSelect.bind(this);
          ...
          InlineDiffView2.prototype.initRenderer = function(restore) {
            var _this = this;
            if (restore) {
          ...
          InlineDiffView2.prototype.initTextLayer = function() {
          ...
          InlineDiffView2.prototype.initTextInput = function(restore) {
            if (restore) {
          ...
          InlineDiffView2.prototype.selectEditor = function(editor) {
          ...
          InlineDiffView2.prototype.removeBracketHighlight = function(editor) {
            var session = editor.session;
          ...
          InlineDiffView2.prototype.initMouse = function() {
            var _this = this;
          ...
          InlineDiffView2.prototype.align = function() {
            var diffView = this;
          ...
          InlineDiffView2.prototype.onChangeWrapLimit = function(e, session) {
          ...
          InlineDiffView2.prototype.$attachSessionsEventHandlers = function() {
          ...
          InlineDiffView2.prototype.$attachSessionEventHandlers = function(editor, marker) {
          ...
          InlineDiffView2.prototype.$detachSessionsEventHandlers = function() {
          ...
          InlineDiffView2.prototype.$detachSessionHandlers = function(editor, marker) {
          ...
          InlineDiffView2.prototype.$attachEventHandlers = function() {
          ...
          InlineDiffView2.prototype.$detachEventHandlers = function() {
            this.$detachSessionsEventHandlers();
          ...
          InlineDiffView2.prototype.onAfterRender = function(changes, renderer) {
            ...
            newConfig.firstRowScreen = config2.firstRowScreen;
            cloneRenderer.$cursorLayer.config = newConfig;
            cloneRenderer.$cursorLayer.update(newConfig);
            if (changes & cloneRenderer.CHANGE_LINES || changes & cloneRenderer.CHANGE_FULL || changes & cloneRenderer.CHANGE_SCROLL || changes & cloneRenderer.CHANGE_TEXT)
              this.textLayer.update(newConfig);
            this.markerLayer.setMarkers(this.otherSession.getMarkers());
            this.markerLayer.update(newConfig);
          };
          InlineDiffView2.prototype.detach = function() {
            _super.prototype.detach.call(this);
            this.otherEditor && this.otherEditor.destroy();
          };
          return InlineDiffView2;
        })(BaseDiffView)
      );
      exports2.InlineDiffView = InlineDiffView;
    });
    ace.define("ace/ext/diff/split_diff_view", ["require", "exports", "module", "ace/ext/diff/base_diff_view", "ace/config"], function(require2, exports2, module2) {
      "use strict";
      var __extends = this && this.__extends || /* @__PURE__ */ (function() {
        var extendStatics = function(d, b) {
          extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
      ...
      var SplitDiffView = (
        /** @class */
        (function(_super) {
          __extends(SplitDiffView2, _super);
          function SplitDiffView2(diffModel) {
            var _this = this;
            diffModel = diffModel || {};
          ...
          SplitDiffView2.prototype.init = function(diffModel) {
            this.onChangeTheme = this.onChangeTheme.bind(this);
          ...
          SplitDiffView2.prototype.onChangeWrapLimit = function() {
            this.scheduleRealign();
          };
          SplitDiffView2.prototype.align = function() {
            var diffView = this;
            this.$initWidgets(diffView.editorA);
            this.$initWidgets(diffView.editorB);
            diffView.chunks.forEach(function(ch) {
          ...
          SplitDiffView2.prototype.onScroll = function(e, session) {
            this.syncScroll(this.sessionA === session ? this.editorA.renderer : this.editorB.renderer);
          };
          SplitDiffView2.prototype.syncScroll = function(renderer) {
            ...
            if (this.scrollSetBy != renderer) {
              if (isOrig && this.scrollA == r.session.getScrollTop())
                return;
              else if (!isOrig && this.scrollB == r.session.getScrollTop())
                return;
            }
          ...
          SplitDiffView2.prototype.onMouseWheel = function(ev) {
            if (ev.getAccelKey())
              return;
          ...
          SplitDiffView2.prototype.$attachSessionsEventHandlers = function() {
            this.$attachSessionEventHandlers(this.editorA, this.markerA);
            this.$attachSessionEventHandlers(this.editorB, this.markerB);
          };
          SplitDiffView2.prototype.$attachSessionEventHandlers = function(editor, marker) {
          ...
          SplitDiffView2.prototype.$detachSessionsEventHandlers = function() {
            this.$detachSessionHandlers(this.editorA, this.markerA);
            this.$detachSessionHandlers(this.editorB, this.markerB);
          };
          SplitDiffView2.prototype.$detachSessionHandlers = function(editor, marker) {
          ...
          SplitDiffView2.prototype.$attachEventHandlers = function() {
          ...
          SplitDiffView2.prototype.$detachEventHandlers = function() {
            this.$detachSessionsEventHandlers();
            this.clearSelectionMarkers();
          ...
          SplitDiffView2.prototype.$detachEditorEventHandlers = function(editor) {
            editor.off("mousewheel", this.onMouseWheel);
            editor.off("input", this.onInput);
          };
          return SplitDiffView2;
        })(BaseDiffView)
      );
      exports2.SplitDiffView = SplitDiffView;
    });
    ace.define("ace/ext/diff/providers/default", ["require", "exports", "module", "ace/range", "ace/ext/diff/base_diff_view"], function(require2, exports2, module2) {
      "use strict";
      var __extends = this && this.__extends || /* @__PURE__ */ (function() {
        var extendStatics = function(d, b) {
          extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
        ...
        return __generator(this, function(_g) {
          switch (_g.label) {
            case 0:
              ...
              _g.label = 1;
            case 1:
              if (!!items_1_1.done) return [3, 7];
              item = items_1_1.value;
              if (!(last !== void 0 && shouldBeGrouped(last, item))) return [3, 2];
              currentGroup.push(item);
              return [3, 5];
            case 2:
              if (!currentGroup) return [3, 4];
              return [4, currentGroup];
            case 3:
              _g.sent();
              _g.label = 4;
            case 4:
      ...
      function pushMany(arr, items) {
        ...
        try {
          ...
          try {
            if (items_2_1 && !items_2_1.done && (_a2 = items_2.return)) _a2.call(items_2);
          } finally {
      ...
      var BugIndicatingError = (
        /** @class */
        (function(_super) {
          __extends(BugIndicatingError2, _super);
          function BugIndicatingError2(message) {
            var _this = _super.call(this, message || "An unexpected bug occurred.") || this;
            Object.setPrototypeOf(_this, BugIndicatingError2.prototype);
            return _this;
          }
          return BugIndicatingError2;
        })(Error)
      );
      ...
      var OffsetRange = (
        /** @class */
        (function() {
          function OffsetRange2(start, endExclusive) {
            this.start = start;
          ...
          OffsetRange2.fromTo = function(start, endExclusive) {
            return new OffsetRange2(start, endExclusive);
          };
          OffsetRange2.addRange = function(range, sortedRanges) {
            var i = 0;
            ...
            if (i === j) {
              ...
              sortedRanges.splice(i, j - i, new OffsetRange2(start, end));
            }
          };
          OffsetRange2.tryCreate = function(start, endExclusive) {
            if (start > endExclusive) {
              return void 0;
            }
            return new OffsetRange2(start, endExclusive);
          };
          OffsetRange2.ofLength = function(length) {
            return new OffsetRange2(0, length);
          };
          OffsetRange2.ofStartAndLength = function(start, length) {
            return new OffsetRange2(start, start + length);
          };
          OffsetRange2.emptyAt = function(offset) {
            return new OffsetRange2(offset, offset);
          };
          Object.defineProperty(OffsetRange2.prototype, "isEmpty", {
            get: function() {
          ...
          OffsetRange2.prototype.delta = function(offset) {
            return new OffsetRange2(this.start + offset, this.endExclusive + offset);
          };
          OffsetRange2.prototype.deltaStart = function(offset) {
            return new OffsetRange2(this.start + offset, this.endExclusive);
          };
          OffsetRange2.prototype.deltaEnd = function(offset) {
            return new OffsetRange2(this.start, this.endExclusive + offset);
          };
          Object.defineProperty(OffsetRange2.prototype, "length", {
            get: function() {
          ...
          OffsetRange2.prototype.toString = function() {
            return "[".concat(this.start, ", ").concat(this.endExclusive, ")");
          };
          OffsetRange2.prototype.equals = function(other) {
            return this.start === other.start && this.endExclusive === other.endExclusive;
          };
          OffsetRange2.prototype.containsRange = function(other) {
            return this.start <= other.start && other.endExclusive <= this.endExclusive;
          };
          OffsetRange2.prototype.contains = function(offset) {
            return this.start <= offset && offset < this.endExclusive;
          };
          OffsetRange2.prototype.join = function(other) {
            return new OffsetRange2(Math.min(this.start, other.start), Math.max(this.endExclusive, other.endExclusive));
          };
          OffsetRange2.prototype.intersect = function(other) {
            var start = Math.max(this.start, other.start);
            var end = Math.min(this.endExclusive, other.endExclusive);
            if (start <= end) {
              return new OffsetRange2(start, end);
            }
            return void 0;
          };
          OffsetRange2.prototype.intersectionLength = function(range) {
            var start = Math.max(this.start, range.start);
            var end = Math.min(this.endExclusive, range.endExclusive);
            return Math.max(0, end - start);
          };
          OffsetRange2.prototype.intersects = function(other) {
            var start = Math.max(this.start, other.start);
            var end = Math.min(this.endExclusive, other.endExclusive);
            return start < end;
          };
          OffsetRange2.prototype.intersectsOrTouches = function(other) {
            var start = Math.max(this.start, other.start);
            var end = Math.min(this.endExclusive, other.endExclusive);
            return start <= end;
          };
          OffsetRange2.prototype.isBefore = function(other) {
            return this.endExclusive <= other.start;
          };
          OffsetRange2.prototype.isAfter = function(other) {
            return this.start >= other.endExclusive;
          };
          OffsetRange2.prototype.slice = function(arr) {
            return arr.slice(this.start, this.endExclusive);
          };
          OffsetRange2.prototype.substring = function(str) {
            return str.substring(this.start, this.endExclusive);
          };
          OffsetRange2.prototype.clip = function(value) {
            if (this.isEmpty) {
              throw new BugIndicatingError("Invalid clipping range: ".concat(this.toString()));
            }
            return Math.max(this.start, Math.min(this.endExclusive - 1, value));
          };
          OffsetRange2.prototype.clipCyclic = function(value) {
            if (this.isEmpty) {
              throw new BugIndicatingError("Invalid clipping range: ".concat(this.toString()));
            }
            if (value < this.start) {
          ...
          OffsetRange2.prototype.map = function(f) {
            var result = [];
          ...
          OffsetRange2.prototype.forEach = function(f) {
            for (var i = this.start; i < this.endExclusive; i++) {
              f(i);
            }
          };
      ...
      var Range = (
        ...
        (function() {
          ...
          Range2.prototype.collapseToEnd = function() {
            return Range2.collapseToEnd(this);
          };
          Range2.collapseToEnd = function(range) {
      ...
      var MonotonousArray = (
        /** @class */
        (function() {
          function MonotonousArray2(_array) {
            this._array = _array;
            this._findLastMonotonousLastIdx = 0;
          }
          MonotonousArray2.prototype.findLastMonotonous = function(predicate) {
            var e_3, _a2;
      ...
      var LineRange = (
        /** @class */
        (function() {
          function LineRange2(startLineNumber, endLineNumberExclusive) {
          ...
          LineRange2.fromRangeInclusive = function(range) {
            return new LineRange2(range.startLineNumber, range.endLineNumber + 1);
          };
          LineRange2.join = function(lineRanges) {
            ...
            return new LineRange2(startLineNumber, endLineNumberExclusive);
          };
          LineRange2.ofLength = function(startLineNumber, length) {
            return new LineRange2(startLineNumber, startLineNumber + length);
          };
          Object.defineProperty(LineRange2.prototype, "isEmpty", {
            get: function() {
          ...
          LineRange2.prototype.delta = function(offset) {
            return new LineRange2(this.startLineNumber + offset, this.endLineNumberExclusive + offset);
          };
          Object.defineProperty(LineRange2.prototype, "length", {
            get: function() {
          ...
          LineRange2.prototype.join = function(other) {
            return new LineRange2(Math.min(this.startLineNumber, other.startLineNumber), Math.max(this.endLineNumberExclusive, other.endLineNumberExclusive));
          };
          LineRange2.prototype.intersect = function(other) {
          ...
          LineRange2.prototype.overlapOrTouch = function(other) {
            return this.startLineNumber <= other.endLineNumberExclusive && other.startLineNumber <= this.endLineNumberExclusive;
          };
          LineRange2.prototype.toInclusiveRange = function() {
            if (this.isEmpty) {
              return null;
            }
            return new Range(this.startLineNumber, 1, this.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER);
          };
          LineRange2.prototype.toOffsetRange = function() {
      ...
      var LineRangeSet = (
        /** @class */
        (function() {
          function LineRangeSet2(_normalizedRanges) {
            if (_normalizedRanges === void 0) {
              _normalizedRanges = [];
            }
            this._normalizedRanges = _normalizedRanges;
          }
          Object.defineProperty(LineRangeSet2.prototype, "ranges", {
            get: function() {
          ...
          LineRangeSet2.prototype.addRange = function(range) {
            if (range.length === 0) {
              return;
            }
          ...
          LineRangeSet2.prototype.contains = function(lineNumber) {
          ...
          LineRangeSet2.prototype.subtractFrom = function(range) {
            var joinRangeStartIdx = findFirstIdxMonotonousOrArrLen(this._normalizedRanges, function(r2) {
              return r2.endLineNumberExclusive >= range.startLineNumber;
            });
            var joinRangeEndIdxExclusive = findLastIdxMonotonous(this._normalizedRanges, function(r2) {
              return r2.startLineNumber <= range.endLineNumberExclusive;
            }) + 1;
            if (joinRangeStartIdx === joinRangeEndIdxExclusive) {
              return new LineRangeSet2([range]);
            }
            var result = [];
            ...
            return new LineRangeSet2(result);
          };
          LineRangeSet2.prototype.getIntersection = function(other) {
            var result = [];
            var i1 = 0;
            var i2 = 0;
          ...
          LineRangeSet2.prototype.getWithDelta = function(value) {
            return new LineRangeSet2(this._normalizedRanges.map(function(r) {
              return r.delta(value);
            }));
          };
          return LineRangeSet2;
        })()
      );
      var TextLength = (
        /** @class */
        (function() {
          function TextLength2(lineCount, columnCount) {
            this.lineCount = lineCount;
            this.columnCount = columnCount;
          }
          TextLength2.prototype.toLineRange = function() {
            return LineRange.ofLength(1, this.lineCount);
          };
          TextLength2.prototype.addToPosition = function(position) {
            if (this.lineCount === 0) {
      ...
      var LineBasedText = (
        /** @class */
        (function() {
          function LineBasedText2(_getLineContent, _lineCount) {
            assert(_lineCount >= 1);
            this._getLineContent = _getLineContent;
            this._lineCount = _lineCount;
          }
          LineBasedText2.prototype.getValueOfRange = function(range) {
          ...
          LineBasedText2.prototype.getLineLength = function(lineNumber) {
            return this._getLineContent(lineNumber).length;
          };
          Object.defineProperty(LineBasedText2.prototype, "length", {
            get: function() {
          ...
          return LineBasedText2;
        })()
      );
      var ArrayText = (
        /** @class */
        (function(_super) {
          __extends(ArrayText2, _super);
          function ArrayText2(lines) {
      ...
      var LinesDiff = (
        /** @class */
        /* @__PURE__ */ (function() {
          function LinesDiff2(changes, moves, hitTimeout) {
      ...
      var MovedText = (
        /** @class */
        /* @__PURE__ */ (function() {
          function MovedText2(lineRangeMapping, changes) {
      ...
      var LineRangeMapping = (
        /** @class */
        (function() {
          function LineRangeMapping2(originalRange, modifiedRange) {
            this.original = originalRange;
            this.modified = modifiedRange;
          }
          LineRangeMapping2.prototype.join = function(other) {
            return new LineRangeMapping2(this.original.join(other.original), this.modified.join(other.modified));
          };
          Object.defineProperty(LineRangeMapping2.prototype, "changedLineCount", {
            get: function() {
          ...
          LineRangeMapping2.prototype.toRangeMapping = function() {
          ...
          LineRangeMapping2.prototype.toRangeMapping2 = function(original, modified) {
      ...
      var DetailedLineRangeMapping = (
        /** @class */
        (function(_super) {
          __extends(DetailedLineRangeMapping2, _super);
          function DetailedLineRangeMapping2(originalRange, modifiedRange, innerChanges) {
            var _this = _super.call(this, originalRange, modifiedRange) || this;
            _this.innerChanges = innerChanges;
            return _this;
          }
          DetailedLineRangeMapping2.fromRangeMappings = function(rangeMappings) {
            ...
            return new DetailedLineRangeMapping2(originalRange, modifiedRange, rangeMappings);
          };
          DetailedLineRangeMapping2.prototype.flip = function() {
            var _a2;
            return new DetailedLineRangeMapping2(this.modified, this.original, (_a2 = this.innerChanges) === null || _a2 === void 0 ? void 0 : _a2.map(function(c) {
              return c.flip();
            }));
          };
          DetailedLineRangeMapping2.prototype.withInnerChangesFromLineRanges = function() {
            return new DetailedLineRangeMapping2(this.original, this.modified, [this.toRangeMapping()]);
          };
          return DetailedLineRangeMapping2;
        })(LineRangeMapping)
      );
      var RangeMapping = (
        /** @class */
        (function() {
          function RangeMapping2(originalRange, modifiedRange) {
            this.originalRange = originalRange;
            this.modifiedRange = modifiedRange;
          }
          RangeMapping2.join = function(rangeMappings) {
          ...
          RangeMapping2.assertSorted = function(rangeMappings) {
            for (var i = 1; i < rangeMappings.length; i++) {
          ...
          RangeMapping2.prototype.flip = function() {
            return new RangeMapping2(this.modifiedRange, this.originalRange);
          };
          RangeMapping2.prototype.join = function(other) {
            return new RangeMapping2(this.originalRange.plusRange(other.originalRange), this.modifiedRange.plusRange(other.modifiedRange));
          };
          return RangeMapping2;
        })()
      );
      function lineRangeMappingFromRangeMappings(alignments, originalLines, modifiedLines, dontAssertStartLine) {
        ...
        assertFn(function() {
          ...
          return checkAdjacentItems(changes, function(m1, m2) {
            return m2.original.startLineNumber - m1.original.endLineNumberExclusive === m2.modified.startLineNumber - m1.modified.endLineNumberExclusive && // There has to be an unchanged line in between (otherwise both diffs should have been joined)
      ...
      var DiffAlgorithmResult = (
        /** @class */
        (function() {
          function DiffAlgorithmResult2(diffs, hitTimeout) {
            this.diffs = diffs;
            this.hitTimeout = hitTimeout;
          }
          DiffAlgorithmResult2.trivial = function(seq1, seq2) {
            return new DiffAlgorithmResult2([new SequenceDiff(OffsetRange.ofLength(seq1.length), OffsetRange.ofLength(seq2.length))], false);
          };
          DiffAlgorithmResult2.trivialTimedOut = function(seq1, seq2) {
            return new DiffAlgorithmResult2([new SequenceDiff(OffsetRange.ofLength(seq1.length), OffsetRange.ofLength(seq2.length))], true);
          };
          return DiffAlgorithmResult2;
        })()
      );
      var SequenceDiff = (
        /** @class */
        (function() {
          function SequenceDiff2(seq1Range, seq2Range) {
            this.seq1Range = seq1Range;
            this.seq2Range = seq2Range;
          }
          SequenceDiff2.invert = function(sequenceDiffs, doc1Length) {
            var result = [];
            forEachAdjacent(sequenceDiffs, function(a, b) {
              result.push(SequenceDiff2.fromOffsetPairs(a ? a.getEndExclusives() : OffsetPair.zero, b ? b.getStarts() : new OffsetPair(doc1Length, (a ? a.seq2Range.endExclusive - a.seq1Range.endExclusive : 0) + doc1Length)));
            });
            return result;
          };
          SequenceDiff2.fromOffsetPairs = function(start, endExclusive) {
            return new SequenceDiff2(new OffsetRange(start.offset1, endExclusive.offset1), new OffsetRange(start.offset2, endExclusive.offset2));
          };
          SequenceDiff2.assertSorted = function(sequenceDiffs) {
            var e_5, _a2;
            var last = void 0;
            try {
              ...
              try {
                if (sequenceDiffs_1_1 && !sequenceDiffs_1_1.done && (_a2 = sequenceDiffs_1.return)) _a2.call(sequenceDiffs_1);
              } finally {
                if (e_5) throw e_5.error;
              }
            }
          };
          SequenceDiff2.prototype.swap = function() {
            return new SequenceDiff2(this.seq2Range, this.seq1Range);
          };
          SequenceDiff2.prototype.join = function(other) {
            return new SequenceDiff2(this.seq1Range.join(other.seq1Range), this.seq2Range.join(other.seq2Range));
          };
          SequenceDiff2.prototype.delta = function(offset) {
            if (offset === 0) {
              return this;
            }
            return new SequenceDiff2(this.seq1Range.delta(offset), this.seq2Range.delta(offset));
          };
          SequenceDiff2.prototype.deltaStart = function(offset) {
            if (offset === 0) {
              return this;
            }
            return new SequenceDiff2(this.seq1Range.deltaStart(offset), this.seq2Range.deltaStart(offset));
          };
          SequenceDiff2.prototype.deltaEnd = function(offset) {
            if (offset === 0) {
              return this;
            }
            return new SequenceDiff2(this.seq1Range.deltaEnd(offset), this.seq2Range.deltaEnd(offset));
          };
          SequenceDiff2.prototype.intersect = function(other) {
            var i1 = this.seq1Range.intersect(other.seq1Range);
            var i2 = this.seq2Range.intersect(other.seq2Range);
            if (!i1 || !i2) {
              return void 0;
            }
            return new SequenceDiff2(i1, i2);
          };
          SequenceDiff2.prototype.getStarts = function() {
            return new OffsetPair(this.seq1Range.start, this.seq2Range.start);
          };
          SequenceDiff2.prototype.getEndExclusives = function() {
            return new OffsetPair(this.seq1Range.endExclusive, this.seq2Range.endExclusive);
          };
          return SequenceDiff2;
        })()
      );
      var OffsetPair = (
        /** @class */
        (function() {
          function OffsetPair2(offset1, offset2) {
            this.offset1 = offset1;
            this.offset2 = offset2;
          }
          OffsetPair2.prototype.delta = function(offset) {
            if (offset === 0) {
              return this;
            }
            return new _d(this.offset1 + offset, this.offset2 + offset);
          };
          OffsetPair2.prototype.equals = function(other) {
      ...
      var InfiniteTimeout = (
        /** @class */
        (function() {
          function InfiniteTimeout2() {
          }
          InfiniteTimeout2.prototype.isValid = function() {
            return true;
          };
          return InfiniteTimeout2;
        })()
      );
      _e = InfiniteTimeout;
      (function() {
      ...
      var DateTimeout = (
        ...
        (function() {
          ...
          DateTimeout2.prototype.isValid = function() {
          ...
          DateTimeout2.prototype.disable = function() {
      ...
      var Array2D = (
        /** @class */
        (function() {
          function Array2D2(width, height) {
            this.width = width;
            this.height = height;
            this.array = [];
            this.array = new Array(width * height);
          }
          Array2D2.prototype.get = function(x, y) {
            return this.array[x + y * this.width];
          };
          Array2D2.prototype.set = function(x, y, value) {
      ...
      var LineRangeFragment = (
        /** @class */
        (function() {
          function LineRangeFragment2(range, lines, source) {
            this.range = range;
            this.lines = lines;
            this.source = source;
            this.histogram = [];
          ...
          LineRangeFragment2.getKey = function(chr) {
          ...
          LineRangeFragment2.prototype.computeSimilarity = function(other) {
            var _a2, _g;
            var sumDifferences = 0;
            var maxLength = Math.max(this.histogram.length, other.histogram.length);
            for (var i = 0; i < maxLength; i++) {
              sumDifferences += Math.abs(((_a2 = this.histogram[i]) !== null && _a2 !== void 0 ? _a2 : 0) - ((_g = other.histogram[i]) !== null && _g !== void 0 ? _g : 0));
            }
            return 1 - sumDifferences / (this.totalCount + other.totalCount);
          };
          return LineRangeFragment2;
        })()
      );
      ...
      var DynamicProgrammingDiffing = (
        /** @class */
        (function() {
          function DynamicProgrammingDiffing2() {
          }
          DynamicProgrammingDiffing2.prototype.compute = function(sequence1, sequence2, timeout, equalityScore) {
            if (timeout === void 0) {
            ...
            function reportDecreasingAligningPositions(s122, s222) {
              if (s122 + 1 !== lastAligningPosS1 || s222 + 1 !== lastAligningPosS2) {
                result.push(new SequenceDiff(new OffsetRange(s122 + 1, lastAligningPosS1), new OffsetRange(s222 + 1, lastAligningPosS2)));
              }
              lastAligningPosS1 = s122;
              lastAligningPosS2 = s222;
            }
          ...
          return DynamicProgrammingDiffing2;
        })()
      );
      var MyersDiffAlgorithm = (
        /** @class */
        (function() {
          function MyersDiffAlgorithm2() {
          }
          MyersDiffAlgorithm2.prototype.compute = function(seq1, seq2, timeout) {
            if (timeout === void 0) {
              timeout = InfiniteTimeout.instance;
            }
          ...
          return MyersDiffAlgorithm2;
        })()
      );
      var SnakePath = (
        /** @class */
        /* @__PURE__ */ (function() {
          function SnakePath2(prev, x, y, length) {
            this.prev = prev;
            this.x = x;
            this.y = y;
            this.length = length;
      ...
      var FastInt32Array = (
        /** @class */
        (function() {
          function FastInt32Array2() {
            this.positiveArr = new Int32Array(10);
            this.negativeArr = new Int32Array(10);
          }
          FastInt32Array2.prototype.get = function(idx) {
            if (idx < 0) {
              idx = -idx - 1;
          ...
          FastInt32Array2.prototype.set = function(idx, value) {
            if (idx < 0) {
              idx = -idx - 1;
          ...
          return FastInt32Array2;
        })()
      );
      var FastArrayNegativeIndices = (
        /** @class */
        (function() {
          function FastArrayNegativeIndices2() {
            this.positiveArr = [];
            this.negativeArr = [];
          }
          FastArrayNegativeIndices2.prototype.get = function(idx) {
            if (idx < 0) {
              idx = -idx - 1;
              return this.negativeArr[idx];
            } else {
          ...
          FastArrayNegativeIndices2.prototype.set = function(idx, value) {
            if (idx < 0) {
              idx = -idx - 1;
              this.negativeArr[idx] = value;
            } else {
          ...
          return FastArrayNegativeIndices2;
        })()
      );
      var SetMap = (
        /** @class */
        (function() {
          ...
          SetMap2.prototype.add = function(key, value) {
          ...
          SetMap2.prototype.forEach = function(key, fn) {
            var values = this.map.get(key);
            if (!values) {
              return;
            }
          ...
          SetMap2.prototype.get = function(key) {
            var values = this.map.get(key);
            if (!values) {
      ...
      var LinesSliceCharSequence = (
        /** @class */
        (function() {
          function LinesSliceCharSequence2(lines, range, considerWhitespaceChanges) {
            this.lines = lines;
            this.range = range;
          ...
          LinesSliceCharSequence2.prototype.toString = function() {
            return 'Slice: "'.concat(this.text, '"');
          };
          Object.defineProperty(LinesSliceCharSequence2.prototype, "text", {
            get: function() {
          ...
          LinesSliceCharSequence2.prototype.getText = function(range) {
            return this.elements.slice(range.start, range.endExclusive).map(function(e) {
              return String.fromCharCode(e);
            }).join("");
          };
          LinesSliceCharSequence2.prototype.getElement = function(offset) {
            return this.elements[offset];
          };
          Object.defineProperty(LinesSliceCharSequence2.prototype, "length", {
            get: function() {
          ...
          LinesSliceCharSequence2.prototype.getBoundaryScore = function(length) {
          ...
          LinesSliceCharSequence2.prototype.translateOffset = function(offset, preference) {
          ...
          LinesSliceCharSequence2.prototype.translateRange = function(range) {
          ...
          LinesSliceCharSequence2.prototype.findWordContaining = function(offset) {
          ...
          LinesSliceCharSequence2.prototype.findSubWordContaining = function(offset) {
            if (offset < 0 || offset >= this.elements.length) {
              return void 0;
            }
            if (!isWordChar(this.elements[offset])) {
          ...
          LinesSliceCharSequence2.prototype.countLinesIn = function(range) {
            return this.translateOffset(range.endExclusive).lineNumber - this.translateOffset(range.start).lineNumber;
          };
          LinesSliceCharSequence2.prototype.isStronglyEqual = function(offset1, offset2) {
            return this.elements[offset1] === this.elements[offset2];
          };
          LinesSliceCharSequence2.prototype.extendToFullLines = function(range) {
            var _a2, _g;
            var start = (_a2 = findLastMonotonous(this.firstElementOffsetByLineIdx, function(x) {
          ...
          return LinesSliceCharSequence2;
        })()
      );
      ...
      function computeMovedLines(changes, originalLines, modifiedLines, hashedOriginalLines, hashedModifiedLines, timeout) {
        var _a2 = computeMovesFromSimpleDeletionsToSimpleInsertions(changes, originalLines, modifiedLines, timeout), moves = _a2.moves, excludedChanges = _a2.excludedChanges;
        if (!timeout.isValid()) {
          return [];
        }
      ...
      function computeMovesFromSimpleDeletionsToSimpleInsertions(changes, originalLines, modifiedLines, timeout) {
        ...
        try {
          ...
          try {
            if (deletions_1_1 && !deletions_1_1.done && (_a2 = deletions_1.return)) _a2.call(deletions_1);
          } finally {
      ...
      function computeUnchangedMoves(changes, hashedOriginalLines, hashedModifiedLines, originalLines, modifiedLines, timeout) {
        var e_9, _a2, e_10, _g, e_11, _h, e_12, _j;
        var moves = [];
        ...
        try {
          ...
          try {
            if (changes_1_1 && !changes_1_1.done && (_a2 = changes_1.return)) _a2.call(changes_1);
          } finally {
        ...
        var _loop_1 = function(change2) {
          var lastMappings = [];
          var _loop_3 = function(i3) {
            var key2 = "".concat(hashedModifiedLines[i3 - 1], ":").concat(hashedModifiedLines[i3 + 1 - 1], ":").concat(hashedModifiedLines[i3 + 2 - 1]);
            var currentModifiedRange = new LineRange(i3, i3 + 3);
            var nextMappings = [];
            original3LineHashes.forEach(key2, function(_a3) {
              var e_13, _g2;
              var range = _a3.range;
              try {
                ...
                try {
                  if (lastMappings_1_1 && !lastMappings_1_1.done && (_g2 = lastMappings_1.return)) _g2.call(lastMappings_1);
                } finally {
              ...
              possibleMappings.push(mapping2);
              nextMappings.push(mapping2);
            });
            lastMappings = nextMappings;
          };
          for (var i2 = change2.modified.startLineNumber; i2 < change2.modified.endLineNumberExclusive - 2; i2++) {
            _loop_3(i2);
          }
          if (!timeout.isValid()) {
            return { value: [] };
      ...
      function areLinesSimilar(line1, line2, timeout) {
        ...
        try {
          ...
          try {
            if (inverted_1_1 && !inverted_1_1.done && (_a2 = inverted_1.return)) _a2.call(inverted_1);
          } finally {
      ...
      function shiftSequenceDiffs(sequence1, sequence2, sequenceDiffs) {
        ...
        for (var i = 0; i < sequenceDiffs.length; i++) {
          ...
          var nextDiff = i + 1 < sequenceDiffs.length ? sequenceDiffs[i + 1] : void 0;
      ...
      function removeShortMatches(sequence1, sequence2, sequenceDiffs) {
        ...
        try {
          ...
          try {
            if (sequenceDiffs_2_1 && !sequenceDiffs_2_1.done && (_a2 = sequenceDiffs_2.return)) _a2.call(sequenceDiffs_2);
          } finally {
      ...
      function extendDiffsToEntireWordIfAppropriate(sequence1, sequence2, sequenceDiffs, findParent, force) {
        ...
        function scanWord(pair, equalMapping) {
          ...
          while (equalMappings.length > 0) {
            var next2 = equalMappings[0];
            var intersects = next2.seq1Range.intersects(w.seq1Range) || next2.seq2Range.intersects(w.seq2Range);
            if (!intersects) {
              break;
            }
            var v1 = findParent(sequence1, next2.seq1Range.start);
            var v2 = findParent(sequence2, next2.seq2Range.start);
            var v = new SequenceDiff(v1, v2);
            var equalPart2 = v.intersect(next2);
            equalChars1 += equalPart2.seq1Range.length;
            equalChars2 += equalPart2.seq2Range.length;
            w = w.join(v);
            if (w.seq1Range.endExclusive >= next2.seq1Range.endExclusive) {
              equalMappings.shift();
            } else {
              break;
            }
      ...
      function removeVeryShortMatchingTextBetweenLongDiffs(sequence1, sequence2, sequenceDiffs) {
        ...
        forEachWithNeighbors(diffs, function(prev, cur, next) {
          ...
          var result2 = newDiff.intersect(availableSpace);
          if (newDiffs.length > 0 && result2.getStarts().equals(newDiffs[newDiffs.length - 1].getEndExclusives())) {
            newDiffs[newDiffs.length - 1] = newDiffs[newDiffs.length - 1].join(result2);
          } else {
            newDiffs.push(result2);
          }
        });
        return newDiffs;
      }
      var LineSequence = (
        /** @class */
        (function() {
          function LineSequence2(trimmedHash, lines) {
            this.trimmedHash = trimmedHash;
            this.lines = lines;
          }
          LineSequence2.prototype.getElement = function(offset) {
            return this.trimmedHash[offset];
          };
          Object.defineProperty(LineSequence2.prototype, "length", {
            get: function() {
          ...
          LineSequence2.prototype.getBoundaryScore = function(length) {
          ...
          LineSequence2.prototype.getText = function(range) {
            return this.lines.slice(range.start, range.endExclusive).join("\n");
          };
          LineSequence2.prototype.isStronglyEqual = function(offset1, offset2) {
      ...
      var DefaultLinesDiffComputer = (
        /** @class */
        (function() {
          function DefaultLinesDiffComputer2() {
            this.dynamicProgrammingDiffing = new DynamicProgrammingDiffing();
            this.myersDiffingAlgorithm = new MyersDiffAlgorithm();
          }
          DefaultLinesDiffComputer2.prototype.computeDiff = function(originalLines, modifiedLines, options) {
            var e_16, _a2;
            var _this = this;
              ...
              for (var i = 0; i < equalLinesCount; i++) {
                ...
                if (originalLines[seq1Offset] !== modifiedLines[seq2Offset]) {
                  ...
                  try {
                    ...
                    try {
                      if (_h && !_h.done && (_a3 = _g.return)) _a3.call(_g);
                    } finally {
            ...
            var seq1LastStart = 0;
            var seq2LastStart = 0;
            var _loop_6 = function(diff2) {
              var e_18, _g;
              assertFn(function() {
                return diff2.seq1Range.start - seq1LastStart === diff2.seq2Range.start - seq2LastStart;
              });
              var equalLinesCount = diff2.seq1Range.start - seq1LastStart;
              scanForWhitespaceChanges(equalLinesCount);
              seq1LastStart = diff2.seq1Range.endExclusive;
              seq2LastStart = diff2.seq2Range.endExclusive;
              var characterDiffs = this_1.refineDiff(originalLines, modifiedLines, diff2, timeout, considerWhitespaceChanges, options);
              if (characterDiffs.hitTimeout) {
                hitTimeout = true;
              }
              try {
            ...
            try {
              ...
              try {
                if (lineAlignments_1_1 && !lineAlignments_1_1.done && (_a2 = lineAlignments_1.return)) _a2.call(lineAlignments_1);
              } finally {
            ...
            assertFn(function() {
              ...
              try {
                ...
                try {
                  if (changes_3_1 && !changes_3_1.done && (_a3 = changes_3.return)) _a3.call(changes_3);
                } finally {
          ...
          DefaultLinesDiffComputer2.prototype.computeMoves = function(changes, originalLines, modifiedLines, hashedOriginalLines, hashedModifiedLines, timeout, considerWhitespaceChanges, options) {
            var _this = this;
          ...
          DefaultLinesDiffComputer2.prototype.refineDiff = function(originalLines, modifiedLines, diff, timeout, considerWhitespaceChanges, options) {
          ...
          return DefaultLinesDiffComputer2;
        })()
      );
      ...
      exports2.computeDiff = computeDiff;
      var AceRange = require2("../../../range").Range;
      var DiffChunk = require2("../base_diff_view").DiffChunk;
      var DiffProvider = (
        /** @class */
        (function() {
          function DiffProvider2() {
          }
          DiffProvider2.prototype.compute = function(originalLines, modifiedLines, opts) {
            if (!opts)
              opts = {};
          ...
          return DiffProvider2;
        })()
      );
      exports2.DiffProvider = DiffProvider;
    });
    ace.define("ace/ext/diff", ["require", "exports", "module", "ace/ext/diff/inline_diff_view", "ace/ext/diff/split_diff_view", "ace/ext/diff/providers/default"], function(require2, exports2, module2) {
      var InlineDiffView = require2("./diff/inline_diff_view").InlineDiffView;
      var SplitDiffView = require2("./diff/split_diff_view").SplitDiffView;
      var DiffProvider = require2("./diff/providers/default").DiffProvider;
      ...
      exports2.SplitDiffView = SplitDiffView;
      exports2.DiffProvider = DiffProvider;
      exports2.createDiffView = createDiffView;
    });
    (function() {
...
export default require_ext_diff();
//# sourceMappingURL=ext-diff-WN6FGM2G.js.map
