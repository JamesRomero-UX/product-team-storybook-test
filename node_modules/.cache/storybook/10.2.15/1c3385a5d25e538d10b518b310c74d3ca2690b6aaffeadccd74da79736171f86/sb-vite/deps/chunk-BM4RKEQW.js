...
} from "./chunk-TCKRP32A.js";
import {
  internal_default
} from "./chunk-WYRCH6W4.js";
import {
  CollectionLabelContext
} from "./chunk-NM2UFPHB.js";
import {
  joinStrings
} from "./chunk-DROBD2RG.js";
import {
  useContainerBreakpoints
} from "./chunk-Z7SMG3UP.js";
import {
  KeyCode
...
// node_modules/.pnpm/@risk-smart+themed-cloudscape-components@0.1.8_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@risk-smart/themed-cloudscape-components/internal/hooks/use-mouse-down-target.js
...
function useMouseDownTarget() {
  const mouseDownTargetRef = (0, import_react.useRef)(null);
...
// node_modules/.pnpm/@risk-smart+themed-cloudscape-components@0.1.8_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@risk-smart/themed-cloudscape-components/table/selection/selection-control.js
var import_react2 = __toESM(require_react());

// node_modules/.pnpm/@risk-smart+themed-cloudscape-components@0.1.8_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@risk-smart/themed-cloudscape-components/table/selection/styles.css.js
import "/Users/jamesromero/Library/CloudStorage/OneDrive-RiskSmart/Product - Product Dream Team/Product-team-storybook/node_modules/.pnpm/@risk-smart+themed-cloudscape-components@0.1.8_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@risk-smart/themed-cloudscape-components/table/selection/styles.scoped.css";
...
function SelectionControl(_a) {
  ...
  const { navigationActive } = (0, import_react2.useContext)(SingleTabStopNavigationContext);
  ...
  const selector = isMultiSelection ? import_react2.default.createElement(internal_default, Object.assign({}, sharedProps, { showOutline: focusedComponent === "selection-control", controlId, "data-focus-id": "selection-control", indeterminate })) : import_react2.default.createElement(radio_button_default, Object.assign({}, sharedProps, { controlId, name, value: "", label: "" }));
  return import_react2.default.createElement(
    import_react2.default.Fragment,
    null,
    import_react2.default.createElement("label", Object.assign({ onKeyDown: handleKeyDown, onKeyUp: setShiftState, onMouseDown: onMouseDownHandler, onMouseUp: setShiftState, onClick: handleClick, htmlFor: controlId, className: clsx_default(styles_css_default.label, styles_css_default.root, verticalAlign === "top" && styles_css_default["label-top"]), "aria-label": ariaLabel, title: ariaLabel }, rowIndex !== void 0 && !sharedProps.disabled ? getAnalyticsMetadataAttribute({
      detail: {
        position: `${rowIndex + 1}`,
        item: itemKey || ""
      }
    }) : {}), selector),
    import_react2.default.createElement("span", { className: styles_css_default.stud, "aria-hidden": true }, " ")
  );
}

// node_modules/.pnpm/@risk-smart+themed-cloudscape-components@0.1.8_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@risk-smart/themed-cloudscape-components/table/utils.js
...
// node_modules/.pnpm/@risk-smart+themed-cloudscape-components@0.1.8_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@risk-smart/themed-cloudscape-components/table/selection/utils.js
...
// node_modules/.pnpm/@risk-smart+themed-cloudscape-components@0.1.8_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@risk-smart/themed-cloudscape-components/table/selection/use-selection-focus-move.js
...
function findSelectionControlByIndex(rootContainer, index) {
  if (index === -1) {
    return rootContainer.querySelector(`[data-${SELECTION_ITEM}="all"] .${styles_css_default.root} input`);
  }
  return rootContainer.querySelectorAll(`[data-${SELECTION_ITEM}="item"] .${styles_css_default.root} input`)[index];
}
function findRootContainer(element) {
  return findUpUntil(element, (node) => node.dataset.selectionRoot === "true");
}

// node_modules/.pnpm/@risk-smart+themed-cloudscape-components@0.1.8_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@risk-smart/themed-cloudscape-components/table/selection/use-selection.js
...
// node_modules/.pnpm/@risk-smart+themed-cloudscape-components@0.1.8_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@risk-smart/themed-cloudscape-components/table/sticky-scrolling.js
...
// node_modules/.pnpm/@risk-smart+themed-cloudscape-components@0.1.8_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@risk-smart/themed-cloudscape-components/table/tools-header.js
var import_react4 = __toESM(require_react());

// node_modules/.pnpm/@risk-smart+themed-cloudscape-components@0.1.8_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@risk-smart/themed-cloudscape-components/table/styles.css.js
import "/Users/jamesromero/Library/CloudStorage/OneDrive-RiskSmart/Product - Product Dream Team/Product-team-storybook/node_modules/.pnpm/@risk-smart+themed-cloudscape-components@0.1.8_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@risk-smart/themed-cloudscape-components/table/styles.scoped.css";
var styles_css_default2 = {
  "root": "awsui_root_wih1l_16x4s_153",
  "tools": "awsui_tools_wih1l_16x4s_164",
  "tools-filtering": "awsui_tools-filtering_wih1l_16x4s_172",
  "tools-align-right": "awsui_tools-align-right_wih1l_16x4s_186",
  "tools-pagination": "awsui_tools-pagination_wih1l_16x4s_190",
  "tools-preferences": "awsui_tools-preferences_wih1l_16x4s_190",
  "tools-small": "awsui_tools-small_wih1l_16x4s_196",
  "table": "awsui_table_wih1l_16x4s_202",
  "table-layout-fixed": "awsui_table-layout-fixed_wih1l_16x4s_208",
  "wrapper": "awsui_wrapper_wih1l_16x4s_212",
  "variant-stacked": "awsui_variant-stacked_wih1l_16x4s_219",
  "wrapper-content-measure": "awsui_wrapper-content-measure_wih1l_16x4s_219",
  "variant-container": "awsui_variant-container_wih1l_16x4s_219",
  "has-footer": "awsui_has-footer_wih1l_16x4s_222",
  "has-header": "awsui_has-header_wih1l_16x4s_225",
  "cell-merged": "awsui_cell-merged_wih1l_16x4s_242",
  "cell-merged-content": "awsui_cell-merged-content_wih1l_16x4s_254",
  "empty": "awsui_empty_wih1l_16x4s_270",
  "loading": "awsui_loading_wih1l_16x4s_274",
  "selection-control": "awsui_selection-control_wih1l_16x4s_283",
  "selection-control-header": "awsui_selection-control-header_wih1l_16x4s_290",
  "header-secondary": "awsui_header-secondary_wih1l_16x4s_296",
  "variant-full-page": "awsui_variant-full-page_wih1l_16x4s_308",
  "table-has-header": "awsui_table-has-header_wih1l_16x4s_314",
  "header-controls": "awsui_header-controls_wih1l_16x4s_325",
  "variant-embedded": "awsui_variant-embedded_wih1l_16x4s_334",
  "variant-borderless": "awsui_variant-borderless_wih1l_16x4s_334",
  "footer-wrapper": "awsui_footer-wrapper_wih1l_16x4s_339",
  "footer": "awsui_footer_wih1l_16x4s_339",
  "footer-with-pagination": "awsui_footer-with-pagination_wih1l_16x4s_347",
  "footer-pagination": "awsui_footer-pagination_wih1l_16x4s_355",
  "thead-active": "awsui_thead-active_wih1l_16x4s_359",
  "row": "awsui_row_wih1l_16x4s_360",
  "row-selected": "awsui_row-selected_wih1l_16x4s_361"
};
...
function ToolsHeader({ header, filter, pagination, preferences, setLastUserAction }) {
  ...
  const assignHeaderId = (0, import_react4.useContext)(CollectionLabelContext).assignId;
  ...
  return import_react4.default.createElement(
    ...
    null,
    isHeaderString ? import_react4.default.createElement("span", { id: headingId }, header) : header,
    hasTools && import_react4.default.createElement(
      "div",
      { ref, className: clsx_default(styles_css_default2.tools, isSmall && styles_css_default2["tools-small"]) },
      filter && import_react4.default.createElement("div", { className: styles_css_default2["tools-filtering"], onClickCapture: () => setLastUserAction === null || setLastUserAction === void 0 ? void 0 : setLastUserAction("filter"), onKeyDownCapture: () => setLastUserAction === null || setLastUserAction === void 0 ? void 0 : setLastUserAction("filter") }, filter),
      import_react4.default.createElement(
        "div",
        { className: styles_css_default2["tools-align-right"] },
        pagination && import_react4.default.createElement("div", { className: styles_css_default2["tools-pagination"], onClickCapture: () => setLastUserAction === null || setLastUserAction === void 0 ? void 0 : setLastUserAction("pagination") }, pagination),
        preferences && import_react4.default.createElement("div", { className: styles_css_default2["tools-preferences"], onClickCapture: () => setLastUserAction === null || setLastUserAction === void 0 ? void 0 : setLastUserAction("preferences") }, preferences)
      )
    )
  );
}
...
//# sourceMappingURL=chunk-BM4RKEQW.js.map
