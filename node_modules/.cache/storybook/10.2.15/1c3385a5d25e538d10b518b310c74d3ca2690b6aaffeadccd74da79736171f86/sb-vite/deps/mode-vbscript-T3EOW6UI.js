...
// node_modules/.pnpm/ace-builds@1.43.6/node_modules/ace-builds/src-noconflict/mode-vbscript.js
var require_mode_vbscript = __commonJS({
  "node_modules/.pnpm/ace-builds@1.43.6/node_modules/ace-builds/src-noconflict/mode-vbscript.js"(exports, module) {
              ...
              if (!stack.length) {
                switch (val) {
                  ...
                  case "do":
                    ...
                    outputRange = doDouble && doDouble.position === "first" ? doDouble.range : stream.getCurrentTokenRange();
                    break;
                  case "loop":
                    if (startTokenValue != "do")
                      ranges.shift();
                    var loopDouble = this.$isDoubleKeyword(token, stream);
                    outputRange = loopDouble && loopDouble.position === "first" ? loopDouble.range : stream.getCurrentTokenRange();
                    break;
                  case "for":
...
export default require_mode_vbscript();
//# sourceMappingURL=mode-vbscript-T3EOW6UI.js.map
