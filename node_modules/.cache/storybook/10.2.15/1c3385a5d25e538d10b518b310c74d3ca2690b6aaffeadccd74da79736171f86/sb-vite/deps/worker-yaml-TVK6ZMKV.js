...
// node_modules/.pnpm/ace-builds@1.43.6/node_modules/ace-builds/src-noconflict/worker-yaml.js
var require_worker_yaml = __commonJS({
  "node_modules/.pnpm/ace-builds@1.43.6/node_modules/ace-builds/src-noconflict/worker-yaml.js"(exports) {
    !(function(window2) {
    ...
    ace.define("ace/mode/yaml/yaml-lint", [], function(require2, exports2, module2) {
      var $build_deps$ = { require: require2, exports: exports2, module: module2 };
      exports2 = void 0;
      module2 = void 0;
      ...
      (function(f) {
        ...
        return (/* @__PURE__ */ (function() {
          ...
          return r;
        })())({ 1: [function(require3, module4, exports4) {
        }, {}], 2: [function(require3, module4, exports4) {
          var fs = require3("fs");
        ...
        }, { "fs": 1, "js-yaml": 3, "lodash.merge": 33 }], 3: [function(require3, module4, exports4) {
          "use strict";
          var yaml = require3("./lib/js-yaml.js");
          module4.exports = yaml;
        }, { "./lib/js-yaml.js": 4 }], 4: [function(require3, module4, exports4) {
          "use strict";
          ...
          module4.exports.Type = require3("./js-yaml/type");
          module4.exports.Schema = require3("./js-yaml/schema");
          module4.exports.FAILSAFE_SCHEMA = require3("./js-yaml/schema/failsafe");
          module4.exports.JSON_SCHEMA = require3("./js-yaml/schema/json");
          module4.exports.CORE_SCHEMA = require3("./js-yaml/schema/core");
          module4.exports.DEFAULT_SAFE_SCHEMA = require3("./js-yaml/schema/default_safe");
          module4.exports.DEFAULT_FULL_SCHEMA = require3("./js-yaml/schema/default_full");
          module4.exports.load = loader.load;
          module4.exports.loadAll = loader.loadAll;
          module4.exports.safeLoad = loader.safeLoad;
          module4.exports.safeLoadAll = loader.safeLoadAll;
          module4.exports.dump = dumper.dump;
          module4.exports.safeDump = dumper.safeDump;
          module4.exports.YAMLException = require3("./js-yaml/exception");
          module4.exports.MINIMAL_SCHEMA = require3("./js-yaml/schema/failsafe");
          module4.exports.SAFE_SCHEMA = require3("./js-yaml/schema/default_safe");
          module4.exports.DEFAULT_SCHEMA = require3("./js-yaml/schema/default_full");
          module4.exports.scan = deprecated("scan");
          module4.exports.parse = deprecated("parse");
          module4.exports.compose = deprecated("compose");
          module4.exports.addConstructor = deprecated("addConstructor");
        }, { "./js-yaml/dumper": 6, "./js-yaml/exception": 7, "./js-yaml/loader": 8, "./js-yaml/schema": 10, "./js-yaml/schema/core": 11, "./js-yaml/schema/default_full": 12, "./js-yaml/schema/default_safe": 13, "./js-yaml/schema/failsafe": 14, "./js-yaml/schema/json": 15, "./js-yaml/type": 16 }], 5: [function(require3, module4, exports4) {
          "use strict";
        ...
        }, {}], 6: [function(require3, module4, exports4) {
          "use strict";
          ...
          module4.exports.dump = dump;
          module4.exports.safeDump = safeDump;
        }, { "./common": 5, "./exception": 7, "./schema/default_full": 12, "./schema/default_safe": 13 }], 7: [function(require3, module4, exports4) {
          "use strict";
          ...
          module4.exports = YAMLException;
        }, {}], 8: [function(require3, module4, exports4) {
          "use strict";
          var common = require3("./common");
          var YAMLException = require3("./exception");
          ...
          module4.exports.loadAll = loadAll;
          module4.exports.load = load;
          module4.exports.safeLoadAll = safeLoadAll;
          module4.exports.safeLoad = safeLoad;
        }, { "./common": 5, "./exception": 7, "./mark": 9, "./schema/default_full": 12, "./schema/default_safe": 13 }], 9: [function(require3, module4, exports4) {
          "use strict";
          var common = require3("./common");
          ...
          module4.exports = Mark;
        }, { "./common": 5 }], 10: [function(require3, module4, exports4) {
          "use strict";
          var common = require3("./common");
          var YAMLException = require3("./exception");
          ...
          module4.exports = Schema;
        }, { "./common": 5, "./exception": 7, "./type": 16 }], 11: [function(require3, module4, exports4) {
          "use strict";
          var Schema = require3("../schema");
          module4.exports = new Schema({
            include: [
              require3("./json")
            ]
          });
        }, { "../schema": 10, "./json": 15 }], 12: [function(require3, module4, exports4) {
          "use strict";
          var Schema = require3("../schema");
          module4.exports = Schema.DEFAULT = new Schema({
            include: [
        ...
        }, { "../schema": 10, "../type/js/function": 21, "../type/js/regexp": 22, "../type/js/undefined": 23, "./default_safe": 13 }], 13: [function(require3, module4, exports4) {
          "use strict";
          var Schema = require3("../schema");
          module4.exports = new Schema({
            include: [
        ...
        }, { "../schema": 10, "../type/binary": 17, "../type/merge": 25, "../type/omap": 27, "../type/pairs": 28, "../type/set": 30, "../type/timestamp": 32, "./core": 11 }], 14: [function(require3, module4, exports4) {
          "use strict";
          var Schema = require3("../schema");
          module4.exports = new Schema({
            explicit: [
        ...
        }, { "../schema": 10, "../type/map": 24, "../type/seq": 29, "../type/str": 31 }], 15: [function(require3, module4, exports4) {
          "use strict";
          var Schema = require3("../schema");
          module4.exports = new Schema({
            include: [
        ...
        }, { "../schema": 10, "../type/bool": 18, "../type/float": 19, "../type/int": 20, "../type/null": 26, "./failsafe": 14 }], 16: [function(require3, module4, exports4) {
          "use strict";
          var YAMLException = require3("./exception");
          ...
          module4.exports = Type;
        }, { "./exception": 7 }], 17: [function(require3, module4, exports4) {
          "use strict";
          var NodeBuffer;
          try {
          ...
          module4.exports = new Type("tag:yaml.org,2002:binary", {
            kind: "scalar",
        ...
        }, { "../type": 16 }], 18: [function(require3, module4, exports4) {
          "use strict";
          var Type = require3("../type");
          ...
          module4.exports = new Type("tag:yaml.org,2002:bool", {
            kind: "scalar",
        ...
        }, { "../type": 16 }], 19: [function(require3, module4, exports4) {
          "use strict";
          var common = require3("../common");
          var Type = require3("../type");
          ...
          module4.exports = new Type("tag:yaml.org,2002:float", {
            kind: "scalar",
        ...
        }, { "../common": 5, "../type": 16 }], 20: [function(require3, module4, exports4) {
          "use strict";
          var common = require3("../common");
          var Type = require3("../type");
          ...
          module4.exports = new Type("tag:yaml.org,2002:int", {
            kind: "scalar",
        ...
        }, { "../common": 5, "../type": 16 }], 21: [function(require3, module4, exports4) {
          "use strict";
          var esprima;
          try {
            var _require = require3;
          ...
          module4.exports = new Type("tag:yaml.org,2002:js/function", {
            kind: "scalar",
        ...
        }, { "../../type": 16 }], 22: [function(require3, module4, exports4) {
          "use strict";
          var Type = require3("../../type");
          ...
          module4.exports = new Type("tag:yaml.org,2002:js/regexp", {
            kind: "scalar",
        ...
        }, { "../../type": 16 }], 23: [function(require3, module4, exports4) {
          "use strict";
          var Type = require3("../../type");
          ...
          module4.exports = new Type("tag:yaml.org,2002:js/undefined", {
            kind: "scalar",
        ...
        }, { "../../type": 16 }], 24: [function(require3, module4, exports4) {
          "use strict";
          var Type = require3("../type");
          module4.exports = new Type("tag:yaml.org,2002:map", {
            kind: "mapping",
            construct: function(data) {
              return data !== null ? data : {};
            }
          });
        }, { "../type": 16 }], 25: [function(require3, module4, exports4) {
          "use strict";
          var Type = require3("../type");
          function resolveYamlMerge(data) {
            return data === "<<" || data === null;
          }
          module4.exports = new Type("tag:yaml.org,2002:merge", {
            kind: "scalar",
            resolve: resolveYamlMerge
          });
        }, { "../type": 16 }], 26: [function(require3, module4, exports4) {
          "use strict";
          var Type = require3("../type");
          ...
          module4.exports = new Type("tag:yaml.org,2002:null", {
            kind: "scalar",
        ...
        }, { "../type": 16 }], 27: [function(require3, module4, exports4) {
          "use strict";
          var Type = require3("../type");
          var _hasOwnProperty = Object.prototype.hasOwnProperty;
          var _toString = Object.prototype.toString;
          ...
          module4.exports = new Type("tag:yaml.org,2002:omap", {
            kind: "sequence",
            resolve: resolveYamlOmap,
            construct: constructYamlOmap
          });
        }, { "../type": 16 }], 28: [function(require3, module4, exports4) {
          "use strict";
          var Type = require3("../type");
          var _toString = Object.prototype.toString;
          ...
          module4.exports = new Type("tag:yaml.org,2002:pairs", {
            kind: "sequence",
            resolve: resolveYamlPairs,
            construct: constructYamlPairs
          });
        }, { "../type": 16 }], 29: [function(require3, module4, exports4) {
          "use strict";
          var Type = require3("../type");
          module4.exports = new Type("tag:yaml.org,2002:seq", {
            kind: "sequence",
            construct: function(data) {
              return data !== null ? data : [];
            }
          });
        }, { "../type": 16 }], 30: [function(require3, module4, exports4) {
          "use strict";
          var Type = require3("../type");
          var _hasOwnProperty = Object.prototype.hasOwnProperty;
          ...
          module4.exports = new Type("tag:yaml.org,2002:set", {
            kind: "mapping",
            resolve: resolveYamlSet,
            construct: constructYamlSet
          });
        }, { "../type": 16 }], 31: [function(require3, module4, exports4) {
          "use strict";
          var Type = require3("../type");
          module4.exports = new Type("tag:yaml.org,2002:str", {
            kind: "scalar",
            construct: function(data) {
              return data !== null ? data : "";
            }
          });
        }, { "../type": 16 }], 32: [function(require3, module4, exports4) {
          "use strict";
          var Type = require3("../type");
          ...
          module4.exports = new Type("tag:yaml.org,2002:timestamp", {
            kind: "scalar",
        ...
        }, { "../type": 16 }], 33: [function(require3, module4, exports4) {
          (function(global2) {
            ...
            var freeExports = typeof exports4 == "object" && exports4 && !exports4.nodeType && exports4;
    ...
    ace.define("ace/mode/yaml_worker", [], function(require2, exports2) {
      "use strict";
      var oop = require2("../lib/oop");
      var Mirror = require2("../worker/mirror").Mirror;
      var lint = require2("./yaml/yaml-lint").lint;
      var YamlWorker = exports2.YamlWorker = function(sender) {
...
export default require_worker_yaml();
//# sourceMappingURL=worker-yaml-TVK6ZMKV.js.map
