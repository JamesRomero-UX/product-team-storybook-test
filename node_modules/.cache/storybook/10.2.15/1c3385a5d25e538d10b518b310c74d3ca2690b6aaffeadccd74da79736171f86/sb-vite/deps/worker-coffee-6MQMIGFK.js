...
// node_modules/.pnpm/ace-builds@1.43.6/node_modules/ace-builds/src-noconflict/worker-coffee.js
var require_worker_coffee = __commonJS({
  "node_modules/.pnpm/ace-builds@1.43.6/node_modules/ace-builds/src-noconflict/worker-coffee.js"(exports, module) {
    !(function(window2) {
              ...
              Ue = ca.compact, He = ca.flatten, Ge = ca.extend, Ze = ca.merge, Ve = ca.del, oa = ca.starts, Be = ca.ends, ta = ca.some, je = ca.addDataToNode, Me = ca.attachCommentsToNode, Ke = ca.locationDataToString, na = ca.throwSyntaxError, e.extend = Ge, e.addDataToNode = je, we = function() {
                ...
                var e2 = (function() {
                  ...
                  return _createClass(e3, [{ key: "compile", value: function compile2(e4, a2) {
                    ...
                    for (p2 = this.children, s2 = 0, d2 = p2.length; s2 < d2; s2++) if (o2 = p2[s2], r2 = this[o2]) if (Array.isArray(r2)) for (l2 = i2 = 0, c2 = r2.length; i2 < c2; l2 = ++i2) {
                      if (n2 = r2[l2], e4(n2)) return t.apply(r2, [l2, l2 - l2 + 1].concat(u2 = a2(n2, this))), u2, true;
                ...
                var e2 = (function(e3) {
                  ...
                  return _inherits(o2, e3), _createClass(o2, [{ key: "compileNode", value: function compileNode(e4) {
                    ...
                    for (this.ctor = null, this.boundMethods = [], o3 = null, i2 = [], r2 = this.body.expressions, s2 = 0, T2 = r2.slice(), p2 = 0, m2 = T2.length; p2 < m2; p2++) if (n2 = T2[p2], n2 instanceof Le && n2.isObject(true)) {
                ...
                var e2 = (function(e3) {
                  ...
                  return _inherits(n2, e3), _createClass(n2, [{ key: "isStatement", value: function isStatement(e4) {
                    ...
                    for (this.value = T2[0], f2 = T2[1], m2 = new c([this]), l2 = 0, i2 = p2.length; l2 < i2; l2++) d2 = p2[l2], g2 = new u(new Le(new K(sa("objectWithoutKeys", e4))), [d2.source, d2.excludeProps]), m2.push(new n2(new Le(d2.name), g2, null, { param: this.param ? "alwaysDeclare" : null }));
                ...
                var e2 = (function(e3) {
                  ...
                  return _inherits(a2, e3), _createClass(a2, [{ key: "jumps", value: function jumps() {
                    ...
                    for (l2 = this.cases, o2 = 0, r2 = l2.length; o2 < r2; o2++) {
                      ...
                      if (t2 = i2[0], a3 = i2[1], n2 = a3.jumps(e4)) return n2;
                    }
...
//# sourceMappingURL=worker-coffee-6MQMIGFK.js.map
