...
// node_modules/.pnpm/@apollo+client@3.13.9_@types+react@19.2.10_graphql@16.13.2_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@apollo/client/testing/react/MockedProvider.js
var React = __toESM(require_react(), 1);

// node_modules/.pnpm/@apollo+client@3.13.9_@types+react@19.2.10_graphql@16.13.2_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@apollo/client/testing/core/mocking/mockLink.js
    ...
    MockLink2.prototype.request = function(operation) {
      ...
      if (!response) {
        configError = new Error("No more mocked responses for the query: ".concat(print(operation.query), "\nExpected variables: ").concat(stringifyForDebugging(operation.variables), "\n").concat(unmatchedVars.length > 0 ? "\nFailed to match ".concat(unmatchedVars.length, " mock").concat(unmatchedVars.length === 1 ? "" : "s", " for this query. The mocked response had the following variables:\n").concat(unmatchedVars.map(function(d) {
          return "  ".concat(stringifyForDebugging(d));
        }).join("\n"), "\n") : ""));
...
function stringifyForDebugging(value, space) {
  ...
  return JSON.stringify(value, function(_, value2) {
    ...
    return value2;
  }, space).replace(new RegExp(JSON.stringify(undefId), "g"), "<undefined>").replace(new RegExp(JSON.stringify(nanId), "g"), "NaN");
}

// node_modules/.pnpm/@apollo+client@3.13.9_@types+react@19.2.10_graphql@16.13.2_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@apollo/client/testing/core/mocking/mockSubscriptionLink.js
...
// node_modules/.pnpm/@apollo+client@3.13.9_@types+react@19.2.10_graphql@16.13.2_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@apollo/client/testing/core/mocking/mockClient.js
...
// node_modules/.pnpm/@apollo+client@3.13.9_@types+react@19.2.10_graphql@16.13.2_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@apollo/client/testing/core/subscribeAndCount.js
...
// node_modules/.pnpm/@apollo+client@3.13.9_@types+react@19.2.10_graphql@16.13.2_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@apollo/client/testing/core/itAsync.js
function wrap(key) {
...
// node_modules/.pnpm/@apollo+client@3.13.9_@types+react@19.2.10_graphql@16.13.2_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@apollo/client/testing/core/wait.js
function wait(ms) {
...
// node_modules/.pnpm/@apollo+client@3.13.9_@types+react@19.2.10_graphql@16.13.2_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@apollo/client/testing/core/withConsoleSpy.js
...
function withErrorSpy(it2) {
  var args = [];
  for (var _i = 1; _i < arguments.length; _i++) {
    args[_i - 1] = arguments[_i];
  }
  args[1] = wrapTestFunction(args[1], "error");
  return it2.apply(void 0, args);
}
function withWarningSpy(it2) {
  var args = [];
  for (var _i = 1; _i < arguments.length; _i++) {
    args[_i - 1] = arguments[_i];
  }
...
//# sourceMappingURL=@apollo_client_testing.js.map
