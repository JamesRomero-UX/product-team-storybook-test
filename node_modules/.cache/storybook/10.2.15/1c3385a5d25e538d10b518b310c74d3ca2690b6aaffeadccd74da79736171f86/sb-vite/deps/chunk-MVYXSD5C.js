import {
  convertAutoComplete,
  useSearchProps
} from "./chunk-FHKRNWSU.js";
import {
  useDebounceCallback
} from "./chunk-7LZWD7WQ.js";
import {
  useFormFieldContext
...
// node_modules/.pnpm/@risk-smart+themed-cloudscape-components@0.1.8_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@risk-smart/themed-cloudscape-components/input/styles.css.js
import "/Users/jamesromero/Library/CloudStorage/OneDrive-RiskSmart/Product - Product Dream Team/Product-team-storybook/node_modules/.pnpm/@risk-smart+themed-cloudscape-components@0.1.8_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@risk-smart/themed-cloudscape-components/input/styles.scoped.css";
var styles_css_default = {
  "root": "awsui_root_2rhyz_vqq7u_145",
  "input": "awsui_input_2rhyz_vqq7u_149",
  "input-readonly": "awsui_input-readonly_2rhyz_vqq7u_196",
  "input-invalid": "awsui_input-invalid_2rhyz_vqq7u_263",
  "input-has-icon-left": "awsui_input-has-icon-left_2rhyz_vqq7u_272",
  "input-warning": "awsui_input-warning_2rhyz_vqq7u_275",
  "input-type-search": "awsui_input-type-search_2rhyz_vqq7u_287",
  "input-has-icon-right": "awsui_input-has-icon-right_2rhyz_vqq7u_300",
  "input-has-no-border-radius": "awsui_input-has-no-border-radius_2rhyz_vqq7u_303",
  "input-container": "awsui_input-container_2rhyz_vqq7u_310",
  "input-icon-left": "awsui_input-icon-left_2rhyz_vqq7u_315",
  "input-icon-right": "awsui_input-icon-right_2rhyz_vqq7u_322",
  "input-button-right": "awsui_input-button-right_2rhyz_vqq7u_328"
};

// node_modules/.pnpm/@risk-smart+themed-cloudscape-components@0.1.8_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@risk-smart/themed-cloudscape-components/input/internal.js
...
function InternalInput(_a, ref) {
  ...
  const attributes = Object.assign({
    ...
    autoFocus,
    id: controlId,
    className: clsx_default(styles_css_default.input, type && styles_css_default[`input-type-${type}`], __rightIcon && styles_css_default["input-has-icon-right"], __leftIcon && styles_css_default["input-has-icon-left"], __noBorderRadius && styles_css_default["input-has-no-border-radius"], {
  ...
  return import_react.default.createElement(
    "div",
    Object.assign({}, baseProps, { className: clsx_default(baseProps.className, styles_css_default["input-container"]), ref: __internalRootRef, dir: type === "email" ? "ltr" : void 0 }),
    ...
    __rightIcon && import_react.default.createElement(
      "span",
      Object.assign({ className: styles_css_default["input-icon-right"] }, __rightIcon === "close" ? getAnalyticsMetadataAttribute({
        action: "clearInput"
      }) : {}),
...
//# sourceMappingURL=chunk-MVYXSD5C.js.map
