...
// node_modules/.pnpm/highcharts@12.5.0/node_modules/highcharts/highcharts-more.js
var require_highcharts_more = __commonJS({
  "node_modules/.pnpm/highcharts@12.5.0/node_modules/highcharts/highcharts-more.js"(exports, module) {
    !/**
    ...
    */
    (function(t, e) {
    ...
    })("u" < typeof window ? exports : window, (t, e, i, s, a, o, r, n, l, h) => (() => {
      "use strict";
      ...
      (p = d || (d = {})).getCenter = function() {
        ...
        let u2 = [S(o2?.[0], "50%"), S(o2?.[1], "50%"), S(h2 && h2 < 0 ? void 0 : t10.size, "100%"), S(p2 && p2 < 0 ? void 0 : t10.innerSize || 0, "0%")];
      ...
      class th extends J {
        ...
        drawDataLabels() {
          ...
          if (l2) {
            if (to(l2) ? (s10 = l2[0] || { enabled: false }, a2 = l2[1] || { enabled: false }) : ((s10 = ta({}, l2)).x = l2.xHigh, s10.y = l2.yHigh, (a2 = ta({}, l2)).x = l2.xLow, a2.y = l2.yLow), s10.enabled || this.hasDataLabels?.()) {
      ...
      class er extends t5 {
        ...
        pointAttribs(t10, e10) {
          let i10 = this.options.marker, s10 = i10?.fillOpacity, a2 = t2.prototype.pointAttribs.call(this, t10, e10);
      ...
      class iw extends ix {
        ...
        repulsiveForces() {
          let { options: t10, k: e10 } = this, { bubblePadding: i10 = 0, seriesInteraction: s10 } = t10, a2 = [...this.nodes, ...this?.chart?.allParentNodes || []];
          for (let t11 of a2) {
        ...
        resolveSplitSeries(t10) {
          ...
          return !iM(e10) && t10.series.chart?.options?.plotOptions?.packedbubble?.layoutAlgorithm?.splitSeries || e10 || false;
        }
        applyLimitBox(t10, e10) {
          let i10, s10;
      ...
      let { parse: iH } = e_(), { noop: iB } = x(), { series: { prototype: iW }, seriesTypes: { bubble: iF } } = M(), { initDataLabels: iG, initDataLabelsDefer: iq } = { initDataLabels: function() {
        ...
        if (!this.dataLabelsGroup) {
          ...
          return !this.chart.styledMode && t10?.style && e10.css(t10.style), e10.attr({ opacity: 0 }), this.visible && (this.options.animation && t10?.animation ? e10.animate({ opacity: 1 }, t10.animation) : e10.attr({ opacity: 1 }), e10.show()), e10;
        }
        return this.dataLabelsGroup.attr({ opacity: 1, ...this.getPlotBox("data-labels") }), this.dataLabelsGroup;
      }, initDataLabelsDefer: function() {
        let t10 = this.options.dataLabels;
        t10?.defer && this.options.layoutAlgorithm?.enableSimulation ? iA(() => {
      ...
      class i0 extends iF {
        ...
        drawGraph() {
          ...
          this.parentNodesGroup = this.plotGroup("parentNodesGroup", "parentNode", this.visible ? "inherit" : "hidden", 0.1, t10.seriesGroup), this.group?.attr({ zIndex: 2 }), this.calculateParentRadius(), this.parentNode && iU(this.parentNode.plotX) && iU(this.parentNode.plotY) && iU(this.parentNodeRadius) && (s10 = iQ({ x: this.parentNode.plotX - this.parentNodeRadius, y: this.parentNode.plotY - this.parentNodeRadius, width: 2 * this.parentNodeRadius, height: 2 * this.parentNodeRadius }, i10), this.parentNode.graphic || (this.graph = this.parentNode.graphic = t10.renderer.symbol(i10.symbol).add(this.parentNodesGroup)), this.parentNode.graphic.attr(s10));
        }
        drawTracker() {
      ...
      let { defaultOptions: i9 } = x(), { noop: i7 } = x(), { addEvent: st, extend: se, isObject: si, merge: ss, relativeLength: sa } = x(), so = { radius: 0, scope: "stack", where: void 0 }, sr = i7, sn = i7;
      function sl(t10, e10, i10, s10, a2 = {}) {
        let o2 = sr(t10, e10, i10, s10, a2), { brStart: r2 = true, brEnd: n2 = true, innerR: l2 = 0, r: h2 = i10, start: p2 = 0, end: d2 = 0 } = a2;
        if (a2.open || !a2.borderRadius) return o2;
        let c2 = d2 - p2, u2 = Math.sin(c2 / 2), g2 = Math.max(Math.min(sa(a2.borderRadius || 0, h2 - l2), (h2 - l2) / 2, h2 * u2 / (1 + u2)), 0), f2 = Math.min(g2, c2 / Math.PI * 2 * l2), m2 = o2.length - 1;
        for (; m2--; ) (r2 || 0 !== m2 && 3 !== m2) && (n2 || 1 !== m2 && 2 !== m2) && !(function(t11, e11, i11) {
          ...
          if ("Z" === n3[0] && (n3 = t11[0]), ("M" === r3[0] || "L" === r3[0]) && "A" === n3[0] ? (s11 = r3, a3 = n3, o3 = true) : "A" === r3[0] && ("M" === n3[0] || "L" === n3[0]) && (s11 = n3, a3 = r3), s11 && a3 && a3.params) {
            let r4 = a3[1], n4 = a3[5], l3 = a3.params, { start: h3, end: p3, cx: d3, cy: c3 } = l3, u3 = n4 ? r4 - i11 : r4 + i11, g3 = u3 ? Math.asin(i11 / u3) : 0, f3 = n4 ? g3 : -g3, m3 = Math.cos(g3) * u3;
      ...
      function sh() {
        if (this.options.borderRadius && !(this.chart.is3d && this.chart.is3d())) {
          let { options: t10, yAxis: e10 } = this, i10 = "percent" === t10.stacking, s10 = i9.plotOptions?.[this.type]?.borderRadius, a2 = sp(t10.borderRadius, si(s10) ? s10 : {}), o2 = e10.options.reversed;
          for (let s11 of this.points) {
            let { shapeArgs: r2 } = s11;
            if ("roundedRect" === s11.shapeType && r2) {
              let { width: n2 = 0, height: l2 = 0, y: h2 = 0 } = r2, p2 = h2, d2 = l2;
              ...
              let g2 = Math.min(sa(a2.radius, n2), n2 / 2, "all" === u2 ? l2 / 2 : 1 / 0) || 0;
              "end" === u2 && (c2 && (p2 -= g2), d2 += g2), se(r2, { brBoxHeight: d2, brBoxY: p2, r: g2 });
            }
          }
        }
      }
      ...
      function sd() {
        let t10 = sp(this.options.borderRadius);
        for (let e10 of this.points) {
          let i10 = e10.shapeArgs;
          i10 && (i10.borderRadius = sa(t10.radius, (i10.r || 0) - (i10.innerR || 0)));
        }
      }
      function sc(t10, e10, i10, s10, a2 = {}) {
        let o2 = sn(t10, e10, i10, s10, a2), { r: r2 = 0, brBoxHeight: n2 = s10, brBoxY: l2 = e10 } = a2, h2 = e10 - l2, p2 = l2 + n2 - (e10 + s10), d2 = h2 - r2 > -0.1 ? 0 : r2, c2 = p2 - r2 > -0.1 ? 0 : r2, u2 = Math.max(d2 && h2, 0), g2 = Math.max(c2 && p2, 0), f2 = [t10 + d2, e10], m2 = [t10 + i10 - d2, e10], b2 = [t10 + i10, e10 + d2], y2 = [t10 + i10, e10 + s10 - c2], x2 = [t10 + i10 - c2, e10 + s10], P2 = [t10 + c2, e10 + s10], M2 = [t10, e10 + s10 - c2], v2 = [t10, e10 + d2], L2 = (t11, e11) => Math.sqrt(Math.pow(t11, 2) - Math.pow(e11, 2));
        if (u2) {
          let t11 = L2(d2, d2 - u2);
      ...
      let sC = c, { animObject: sN } = x(), { optionsToObject: sX } = { compose: function(t10, e10, i10) {
        let s10 = t10.types.pie;
        if (!e10.symbolCustomAttribs.includes("borderRadius")) {
          let a2 = i10.prototype.symbols;
          st(t10, "afterColumnTranslate", sh, { order: 9 }), st(s10, "afterTranslate", sd), e10.symbolCustomAttribs.push("borderRadius", "brBoxHeight", "brBoxY", "brEnd", "brStart"), sr = a2.arc, sn = a2.roundedRect, a2.arc = sl, a2.roundedRect = sc;
        }
      }, optionsToObject: sp }, { defaultOptions: sY } = x(), { composed: sR } = x(), { addEvent: sI, defined: sE, find: sD, isNumber: sz, isObject: sO, merge: sH, pick: sB, pushUnique: sW, relativeLength: sF, splat: sG, uniqueKey: sq, wrap: sV } = x();
      function s_() {
      ...
      function sQ() {
        ...
        if (e10.borderRadius && t10.polar && t10.inverted) {
          let t11 = sY.plotOptions?.[this.type]?.borderRadius, { scope: s10, where: a2 = "end" } = sX(e10.borderRadius, sO(t11) ? t11 : {});
      ...
      !(function(t10) {
        ...
        class o2 {
          ...
          renderStackTotals() {
            let t11 = this.axis, e11 = t11.waterfall?.stacks, i11 = t11.stacking?.stackTotalGroup, s11 = new (as())(t11, t11.options.stackLabels || {}, false, 0, void 0);
      ...
      class ak extends ad {
        ...
        processData(t10) {
          ...
          s10 = i10 = a2 = o2 = 0;
          for (let t11 = 0; t11 < p2; t11++) r2 = l2[t11], e10 = h2?.[t11] || {}, "sum" === r2 || e10.isSum ? l2[t11] = am(s10) : "intermediateSum" === r2 || e10.isIntermediateSum ? (l2[t11] = am(i10), i10 = 0) : (s10 += r2, i10 += r2), a2 = Math.min(s10, a2), o2 = Math.max(s10, o2);
        ...
        getCrispPath() {
          let t10 = this.points.filter((t11) => ax(t11.y)), e10 = this.yAxis, i10 = t10.length, s10 = this.graph?.strokeWidth() || 0, a2 = this.xAxis.reversed, o2 = this.yAxis.reversed, r2 = this.options.stacking, n2 = [];
        ...
        drawGraph() {
          ac.prototype.drawGraph.call(this), this.graph?.animate({ d: this.getCrispPath() });
        }
      ...
      ak.defaultOptions = aP(ad.defaultOptions, { dataLabels: { inside: true }, lineWidth: 1, lineColor: "#333333", dashStyle: "Dot", borderColor: "#333333", states: { hover: { lineWidthPlus: 0 } } }), ak.compose = al.compose, ay(ak.prototype, { pointValKey: "y", showLine: true, pointClass: ap }), au(ak, "afterColumnTranslate", function() {
        let { options: t10, points: e10, yAxis: i10 } = this, s10 = av(t10.minPointLength, 5), a2 = s10 / 2, o2 = t10.threshold || 0, r2 = t10.stacking, n2 = i10.waterfall?.stacks[this.stackKey], l2 = this.getColumn("y", true), h2 = o2, p2 = o2, d2, c2, u2, g2;
