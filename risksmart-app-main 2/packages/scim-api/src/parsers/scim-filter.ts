...
const peggyParser: { parse: any; SyntaxError: any; DefaultTracer?: any } = // Generated by Peggy 3.0.2.
  ...
  (function () {
    ...
    function peg$parse(input, options) {
      ...
      var peg$e9 = peg$literalExpectation('eq', false);
      ...
      var peg$f3 = function (attribute, operator, value) {
        // @ts-ignore
      ...
      peg$parseattrName() {
        ...
        s0 = peg$currPos;
        // @ts-ignore
        s1 = peg$parsecomplexAttrName();
        // @ts-ignore
        if (s1 === peg$FAILED) {
          // @ts-ignore
          s1 = peg$parsesimpleAttrName();
        }
        // @ts-ignore
        if (s1 !== peg$FAILED) {
          // @ts-ignore
...
export type OrExpr = { op: 'or'; left: AndExpr; right: OrExpr } | AndExpr;
export type AndExpr =
  | { op: 'and'; left: PrimaryExpr; right: AndExpr }
  | PrimaryExpr;
export type PrimaryExpr = void | SimpleExpr;
...
export type SimpleAttrName = [string, string[]];
export type ComplexAttrName = [SimpleAttrName, (Subquery | Property)[]];
export type Subquery = ['[', _, SimpleAttrName, _, Op, _, AttrValue, _, ']'];
export type Property = ['.', SimpleAttrName];
export type Op = 'eq';
export type AttrValue = String_1 | Boolean_1 | Null | Number_1;
