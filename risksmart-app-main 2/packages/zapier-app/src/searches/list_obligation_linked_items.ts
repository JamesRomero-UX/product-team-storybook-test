...
export default createSubResourceListSearch({
  ...
  noun: 'Linked Item',
  label: 'List Obligation Linked Items',
  description: 'Lists items linked to a compliance obligation.',
  parentIdLabel: 'Obligation ID',
  parentIdHelpText: 'The UUID of the parent obligation.',
