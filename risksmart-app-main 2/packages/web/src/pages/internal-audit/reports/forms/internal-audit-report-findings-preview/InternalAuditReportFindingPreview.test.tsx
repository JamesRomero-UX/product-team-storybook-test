...
import { waitUntilLoadedDoesNotExist } from 'src/testing/formHelpers';
...
import { mockedGetInternalAuditResultsByParentIdResponse } from '../../../../../testing/mock-data/mockedGetInternalAuditResultsByParentIdResponse';
import { mockedRoleAccessResponse } from '../../../../../testing/mock-data/mockedGetRoleAccessResponse';
import InternalAuditReportFindingPreview from './InternalAuditReportFindingPreview';

describe('InternalAuditReportFindingPreview', () => {
  beforeEach(() => {
    window.localStorage.clear();
  });

  type Action = GetInternalAuditResultsByParentIdQuery['action'][number];
  type Impact = GetInternalAuditResultsByParentIdQuery['impact'][number];
  type Issue = GetInternalAuditResultsByParentIdQuery['issue'][number];
  type TestResult =
    GetInternalAuditResultsByParentIdQuery['control_test_internal_audit_result'][number];

  type TestResultParent = TestResult['parent'];

  type ImpactRating =
    GetInternalAuditResultsByParentIdQuery['impact_internal_audit_rating'][number];
  ...
  const defaultImpactRating: ImpactRating = {
    ...
    __typename: 'impact_internal_audit_rating',
    createdByUser: {
      FriendlyName: 'RiskManager1',
      __typename: 'user',
    },
  ...
  it('does not display findings when no findings exist"', async () => {
    const { container } = render(
      <InternalAuditReportFindingPreview
        internalAuditReportId={'70b8ef93-8118-49aa-8f06-c029ff2c3285'}
        outcome={1}
      />,
      {
        wrapper: getWrapper(
          [
            ...
            mockedGetInternalAuditResultsByParentIdResponse(
              {
                ...
                risk_uncontrolled_internal_audit_result: [
                  {
                    ...
                    __typename: 'risk_uncontrolled_internal_audit_result',
                    parents: [],
                    files: [],
                    ancestorContributors: [],
                  },
          ...
          [
            ...
            mockedGetInternalAuditResultsByParentIdResponse(
              ...
              },
              {
                ...
                obligation_internal_audit_result: [],
                control_test_internal_audit_result: [],
                impact_internal_audit_rating: [defaultImpactRating],
              }
            ),
          ],
          ...defaultFormProvidersWithFeatures
