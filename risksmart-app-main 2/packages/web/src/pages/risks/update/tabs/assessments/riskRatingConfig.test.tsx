...
import type { RiskAssessmentResultFlatFields } from './types';

describe('risk rating result config', () => {
  const TestHarness: FC<{
    records: RiskAssessmentResultFlatFields[];
  }> = ({ records }) => {
    const tableProps = useGetCollectionTableProps(
      { Id: '1', ancestorContributors: [] },
      () => ({}),
      () => ({}),
      records
    );
