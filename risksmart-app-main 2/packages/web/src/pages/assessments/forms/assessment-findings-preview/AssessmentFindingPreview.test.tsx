...
import { mockedGetAssessmentResultsByParentIdResponse } from 'src/testing/mock-data/mockedGetAssessmentResultsByParentIdResponse';
...
import AssessmentFindingPreview from './AssessmentFindingPreview';
...
describe('AssessmentFindingPreview', () => {
  ...
  type Action = GetAssessmentResultsByParentIdQuery['action'][number];
  type Impact = GetAssessmentResultsByParentIdQuery['impact'][number];
  type Issue = GetAssessmentResultsByParentIdQuery['issue'][number];
  type TestResult = GetAssessmentResultsByParentIdQuery['test_result'][number];

  type TestResultParent = TestResult['parent'];

  type ImpactRating =
    GetAssessmentResultsByParentIdQuery['impact_rating'][number];
  ...
  it('does not display findings when no findings exist"', async () => {
    const { container } = render(
      <AssessmentFindingPreview
        assessmentId={'70b8ef93-8118-49aa-8f06-c029ff2c3285'}
        outcome={1}
      />,
      {
        wrapper: getWrapper(
          [
            ...
            mockedGetAssessmentResultsByParentIdResponse(
              {
  ...
  it('does display findings when risk findings exist"', async () => {
    const { container } = render(
      <AssessmentFindingPreview
        assessmentId={'70b8ef93-8118-49aa-8f06-c029ff2c3285'}
        outcome={1}
          ...
          [
            ...
            mockedGetAssessmentResultsByParentIdResponse(
              ...
              },
              {
                ...
                obligation_assessment_result: [],
                test_result: [],
                impact_rating: [defaultImpactRating],
              }
            ),
          ],
          ...defaultFormProviders
  ...
  it('displays all findings when all findings exist"', async () => {
    ...
    expect(screen.queryByText('1 Risk')).toBeInTheDocument();
