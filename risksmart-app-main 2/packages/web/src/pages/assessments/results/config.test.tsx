...
describe('Results config', () => {
  ...
  const assessment: AssessmentResultFields['assessments'][number] = {
    assessment: {
  ...
  const documentAssessmentResult: AssessmentResultFields = {
  ...
  const obligationAssessmentResult: AssessmentResultFields = {
  ...
  const riskAssessmentResult: AssessmentResultFields = {
  ...
  describe('useGetCollectionTableProps', () => {
    ...
    const testMocks = [
      ...
      mockedGetUserTablePreferences('assessmentResultRegister'),
    ];
