...
import { mockedGetComplianceMonitoringAssessmentTestResultsByControlIdResponse } from '../../../../../testing/mock-data/mockedGetComplianceMonitoringAssessmentTestResultsByControlIdResponse';
import { mockedGetInternalAuditReportTestResultsByControlIdResponse } from '../../../../../testing/mock-data/mockedGetInternalAuditReportTestResultsByControlIdResponse';
import { mockedGetTestResultsByControlIdResponse } from '../../../../../testing/mock-data/mockedGetTestResultsByControlIdResponse';
...
import { buildControl } from '../../../../../testing/test-data/control';
import Tab from './Tab';
...
describe('Control test ratings Tab', () => {
  ...
  const mockedResponses = [
    ...
    mockedGetTestResultsByControlIdResponse({
      controlId: '1',
    }),
    mockedGetComplianceMonitoringAssessmentTestResultsByControlIdResponse({
      controlId: '1',
    }),
    mockedGetInternalAuditReportTestResultsByControlIdResponse({
      controlId: '1',
    }),
    mockedGetFormCustomisationResponse([
      Parent_Type_Enum.ControlTestSecondLineResult,
    ...
    mockedGetFormCustomisationResponse([
      Parent_Type_Enum.ControlTestInternalAuditResult,
  ...
  it('should show risk but NOT compliance and internal audit rating tables if not permitted', async () => {
    render(<Tab control={buildControl({})} />, {
      wrapper: getWrapper(
        [
          ...mockedResponses,
  ...
  it('should show risk, internal audit and compliance rating tables if permitted', async () => {
    render(<Tab control={buildControl({})} />, {
      wrapper: getWrapper(
        [
          ...mockedResponses,
