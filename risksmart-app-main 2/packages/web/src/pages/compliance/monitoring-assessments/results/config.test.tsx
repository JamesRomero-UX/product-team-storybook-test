...
describe('Compliance monitoring assessments Results config', () => {
  beforeEach(() => {
    window.localStorage.clear();
  });

  const assessment: ComplianceMonitoringAssessmentResultFields['complianceMonitoringAssessments'][number] =
    {
      ...
      __typename: 'second_line_result_parent',
    };

  const documentAssessmentResult: ComplianceMonitoringAssessmentResultFields = {
    ...
    complianceMonitoringAssessments: [assessment],
    documents: [
      {
        document: {
  ...
  const obligationAssessmentResult: ComplianceMonitoringAssessmentResultFields =
    {
  ...
  const riskAssessmentResult: ComplianceMonitoringAssessmentResultFields = {
  ...
  describe('useGetCollectionTableProps', () => {
    const TestHarness: FC<{
      records: ComplianceMonitoringAssessmentResultFields[];
    }> = ({ records }) => {
    ...
    const testMocks = [
      ...
      mockedGetUserTablePreferences(
        'complianceMonitoringAssessmentResultRegister'
      ),
    ];
