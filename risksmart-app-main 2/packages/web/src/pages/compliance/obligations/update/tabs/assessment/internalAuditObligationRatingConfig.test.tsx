...
import type { InternalAuditObligationAssessmentResultFlatFields } from './types';

describe('internal audit rating result config', () => {
  const TestHarness: FC<{
    records: InternalAuditObligationAssessmentResultFlatFields[];
  }> = ({ records }) => {
