...
import type { ObligationAssessmentResultFlatFields } from './types';

describe('obligation assessment rating result config', () => {
  const TestHarness: FC<{
    records: ObligationAssessmentResultFlatFields[];
  }> = ({ records }) => {
