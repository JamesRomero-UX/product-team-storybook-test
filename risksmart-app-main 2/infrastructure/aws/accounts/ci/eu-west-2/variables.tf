...
variable "repository_name_hybiscus" {
  description = "The name of the ECR repository."
  type        = string
  default     = "hybiscusdev/managed-cloud-api"
}

variable "repository_name_chat_api" {
  description = "The name of the ECR repository."
  type        = string
  default     = "risksmart/chat-api"
}

variable "repository_name_workflow_api" {
  description = "The name of the ECR repository."
  type        = string
  default     = "risksmart/workflow-api"
}
...
variable "repository_name_auth0_mcp" {
  description = "The name of the ECR repository."
  type        = string
  default     = "risksmart/auth0-mcp"
}

variable "ci_account_id" {
  description = "AWS account ID for the CI account"
  type        = string
  default     = "437474201705" // Replace with your actual CI account ID
}
...
variable "bucket_name_external_api_lambda_artifacts" {
  ...
  type        = string
  default     = "ext-api-lambda-artifacts-eu-west-2"
}
