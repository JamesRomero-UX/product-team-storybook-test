...
export declare const instrumentAwsLambda: ((options: AwsLambdaOptions) => AwsLambdaInstrumentation) & {
    id: string;
};
/**
 * Instrumentation for aws-sdk package
 */
export declare const awsLambdaIntegration: (options?: AwsLambdaOptions | undefined) => import("@sentry/core").Integration;
export {};
