...
import { getMultipartBoundary, parseMultipart as parseMultipartWeb, MultipartParseError, } from './multipart.js';
/**
 ...
 */
export async function* parseMultipart(data, boundary, options) {
