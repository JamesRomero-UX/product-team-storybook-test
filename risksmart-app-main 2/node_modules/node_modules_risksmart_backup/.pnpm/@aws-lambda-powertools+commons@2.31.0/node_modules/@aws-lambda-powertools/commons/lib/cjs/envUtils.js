...
exports.shouldUseInvokeStore = exports.getXRayTraceIdFromEnv = exports.isRequestXRaySampled = exports.getXrayTraceDataFromEnv = exports.getServiceName = exports.isDevMode = exports.getBooleanFromEnv = exports.getNumberFromEnv = exports.getStringFromEnv = void 0;
...
const shouldUseInvokeStore = () => {
    const res = getStringFromEnv({
        key: constants_js_1.AWS_LAMBDA_MAX_CONCURRENCY,
        defaultValue: '',
    });
    return res !== '';
};
exports.shouldUseInvokeStore = shouldUseInvokeStore;
/**
