 ...
 * @internal
 */
const mergeArrayItemsByIndex = (targetArray, sourceArray, seen) => {
 ...
 * @internal
 */
const handleArrayMerge = (target, key, sourceArray, targetValue, seen) => {
 ...
 * @internal
 */
const handleObjectMerge = (target, key, sourceObject, targetValue, seen) => {
 ...
 * @internal
 */
const mergeRecursive = (target, source, seen) => {
