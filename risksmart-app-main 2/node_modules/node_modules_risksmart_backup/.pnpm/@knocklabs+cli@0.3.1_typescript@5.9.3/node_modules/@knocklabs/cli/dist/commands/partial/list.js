...
class PartialList extends _basecommand.default {
    ...
    async request(pageParams = {}) {
        ...
        return (0, _request.withSpinner)(()=>this.apiV1.listPartials(props));
    }
    async render(data) {
        const { entries } = data;
...
_define_property(PartialList, "summary", "Display all partials for an environment.");
_define_property(PartialList, "flags", {
...
_define_property(PartialList, "enableJsonFlag", true);
