...
body[data-awsui-focus-visible=true] .awsui_hotspot_1hpp3_tb8th_282:not(#\9):focus::before {
  ...
  border-start-start-radius: var(--border-radius-control-circular-focus-ring-0v2apg, 50%);
  border-start-end-radius: var(--border-radius-control-circular-focus-ring-0v2apg, 50%);
  border-end-start-radius: var(--border-radius-control-circular-focus-ring-0v2apg, 50%);
