...
/*
 ...
 SPDX-License-Identifier: Apache-2.0
*/
@keyframes awsui_spinner-rotator_1612d_2ar68_1 {
  0% {
...
@keyframes awsui_spinner-line-left_1612d_2ar68_1 {
  0% {
...
@keyframes awsui_spinner-line-right_1612d_2ar68_1 {
  0% {
...
.awsui_root_1612d_2ar68_183:not(#\9) {
  ...
  animation: awsui_spinner-rotator_1612d_2ar68_1 0.7s linear infinite;
  box-sizing: border-box;
  line-height: 0;
  /* stylelint-disable-next-line plugin/no-unsupported-browser-features */
}
.awsui_root_1612d_2ar68_183.awsui_size-normal_1612d_2ar68_198:not(#\9) {
  ...
  padding-inline: calc((var(--size-icon-normal-2f5zkr, 16px) - 12px) / 2);
  margin-block: calc((var(--line-height-body-m-bedeoh, 22px) - var(--size-icon-normal-2f5zkr, 16px)) / 2);
  box-sizing: border-box;
}
.awsui_root_1612d_2ar68_183.awsui_size-big_1612d_2ar68_206:not(#\9) {
  ...
  padding-inline: calc((var(--size-icon-big-hnqj8f, 32px) - 24px) / 2);
  margin-block: calc((var(--line-height-heading-xl-vs1f23, 36px) - var(--size-icon-big-hnqj8f, 32px)) / 2);
  box-sizing: border-box;
}
.awsui_root_1612d_2ar68_183.awsui_size-large_1612d_2ar68_214:not(#\9) {
  ...
  padding-inline: calc((var(--size-icon-large-gj7xfw, 48px) - 36px) / 2);
  margin-block: calc((var(--line-height-display-l-3zghmm, 56px) - var(--size-icon-large-gj7xfw, 48px)) / 2);
  box-sizing: border-box;
}
.awsui_root_1612d_2ar68_183.awsui_variant-normal_1612d_2ar68_222:not(#\9) {
  color: currentColor;
}
.awsui_root_1612d_2ar68_183.awsui_variant-disabled_1612d_2ar68_225:not(#\9) {
  color: var(--color-text-interactive-disabled-i9f2yj, #aab7b8);
}
.awsui_root_1612d_2ar68_183.awsui_variant-inverted_1612d_2ar68_228:not(#\9) {
  color: var(--color-text-inverted-vkqxd7, #ffffff);
}
.awsui_root_1612d_2ar68_183:not(#\9):dir(rtl) {
...
.awsui_circle_1612d_2ar68_240:not(#\9) {
  display: inline-block;
  inline-size: 50%;
  block-size: 100%;
  overflow: hidden;
...
.awsui_circle_1612d_2ar68_240:not(#\9):after {
  position: absolute;
  box-sizing: border-box;
  content: "";
...
.awsui_circle_1612d_2ar68_240.awsui_circle-left_1612d_2ar68_268:not(#\9):after {
  inset-inline-start: 0;
  /*stylelint-disable-next-line @cloudscape-design/no-motion-outside-of-mixin */
  animation-name: awsui_spinner-line-left_1612d_2ar68_1;
}
.awsui_circle_1612d_2ar68_240.awsui_circle-right_1612d_2ar68_273:not(#\9):after {
  inset-inline-start: -100%;
  /*stylelint-disable-next-line @cloudscape-design/no-motion-outside-of-mixin */
  animation-name: awsui_spinner-line-right_1612d_2ar68_1;
}