 ...
 */
export declare function buildVpc(scope: Construct, props: BuildVpcProps, id?: string): ec2.IVpc;
...
export declare function calculateIpMaskSize(ipAddressCount: number): number;
