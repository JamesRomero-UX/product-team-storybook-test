...
import { KnockMgmtError } from "./error.mjs";
...
export class AbstractPage {
    ...
    async getNextPage() {
        ...
        if (!nextOptions) {
            throw new KnockMgmtError('No next page expected; please check `.hasNextPage()` before calling `.getNextPage()`.');
        }
...
export class EntriesCursor extends AbstractPage {
    constructor(client, response, body, options) {
