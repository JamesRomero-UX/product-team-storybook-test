...
export declare namespace Commit {
    ...
    interface Resource {
         ...
         */
        type: 'dynamic_audience' | 'email_layout' | 'guide' | 'message_type' | 'partial' | 'translation' | 'workflow';
    }
}
/**
...
export interface CommitListParams extends EntriesCursorParams {
     ...
     */
    resource_type?: 'dynamic_audience' | 'email_layout' | 'guide' | 'message_type' | 'partial' | 'translation' | 'workflow';
}
