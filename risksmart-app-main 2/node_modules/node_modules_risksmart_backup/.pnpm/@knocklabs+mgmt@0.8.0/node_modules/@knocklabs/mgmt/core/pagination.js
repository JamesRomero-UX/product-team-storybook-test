...
exports.EntriesCursor = exports.PagePromise = exports.AbstractPage = void 0;
...
class AbstractPage {
    ...
    async getNextPage() {
        ...
        if (!nextOptions) {
            throw new error_1.KnockMgmtError('No next page expected; please check `.hasNextPage()` before calling `.getNextPage()`.');
        }
...
class EntriesCursor extends AbstractPage {
    constructor(client, response, body, options) {
