...
export declare class ChannelGroups extends APIResource {
    /**
...
export interface ChannelGroupRule {
     ...
     */
    operator?: 'equal_to' | 'not_equal_to' | 'greater_than' | 'less_than' | 'greater_than_or_equal_to' | 'less_than_or_equal_to' | 'contains' | 'not_contains' | 'contains_all' | 'empty' | 'not_empty' | 'is_audience_member' | 'is_not_audience_member' | null;
    /**
...
export declare namespace ChannelGroups {
    export { type ChannelGroup as ChannelGroup, type ChannelGroupRule as ChannelGroupRule, type ChannelGroupsEntriesCursor as ChannelGroupsEntriesCursor, type ChannelGroupListParams as ChannelGroupListParams, };
}
//# sourceMappingURL=channel-groups.d.mts.map