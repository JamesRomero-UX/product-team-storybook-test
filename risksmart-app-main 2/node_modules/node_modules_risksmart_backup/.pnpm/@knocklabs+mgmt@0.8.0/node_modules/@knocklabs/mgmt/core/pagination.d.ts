...
export declare class PagePromise<PageClass extends AbstractPage<Item>, Item = ReturnType<PageClass['getPaginatedItems']>[number]> extends APIPromise<PageClass> implements AsyncIterable<Item> {
    constructor(client: KnockMgmt, request: Promise<APIResponseProps>, Page: new (...args: ConstructorParameters<typeof AbstractPage>) => PageClass);
    /**
...
export declare namespace EntriesCursorResponse {
    interface PageInfo {
        after?: string;
    }
}
...
export declare class EntriesCursor<Item> extends AbstractPage<Item> implements EntriesCursorResponse<Item> {
    entries: Array<Item>;
    page_info: EntriesCursorResponse.PageInfo;
