...
exports.MSWVisitor = exports.validate = exports.plugin = void 0;
const path_1 = require("path");
const graphql_1 = require("graphql");
const plugin_helpers_1 = require("@graphql-codegen/plugin-helpers");
const visitor_js_1 = require("./visitor.js");
Object.defineProperty(exports, "MSWVisitor", { enumerable: true, get: function () { return visitor_js_1.MSWVisitor; } });
const plugin = (schema, documents, config) => {
    ...
    const visitor = new visitor_js_1.MSWVisitor(schema, allFragments, config);
