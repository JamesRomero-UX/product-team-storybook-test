...
class SelfServiceProfileHandler extends default_1.default {
    ...
    async processChanges(assets) {
        ...
        logger_1.default.debug(`Start processChanges for selfServiceProfiles [delete:${changes.del.length}] [update:${changes.update.length}], [create:${changes.create.length}]`);
        const myChanges = [
            { del: changes.del },
