...
import type { ListFlowsInput, ListFlowsOutput } from "../models/models_4";
...
declare const ListFlowsCommand_base: {
    new (input: ListFlowsCommandInput): import("@smithy/smithy-client").CommandImpl<ListFlowsCommandInput, ListFlowsCommandOutput, QuickSightClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ListFlowsCommandInput): import("@smithy/smithy-client").CommandImpl<ListFlowsCommandInput, ListFlowsCommandOutput, QuickSightClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
