...
import { IComponentOptions, ColorThemeVariable, FontSize, VerticalMargin, HorizontalMargin } from "../types";
...
export interface ITableOptions extends IComponentOptions, VerticalMargin, HorizontalMargin {
...
declare class Table extends Component {
    constructor(options?: ITableOptions, componentType?: string);
}
export { Table };
