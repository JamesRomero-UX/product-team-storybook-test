...
import { ColorThemeVariable, FontSize, HorizontalMargin, IComponentOptions, VerticalMargin } from "../types";
...
export interface IDataTableOptions extends IComponentOptions, VerticalMargin, HorizontalMargin {
    rows: Array<Array<IDataTableCell>>;
    col_types: Array<"Text" | "SparkLine" | "SparkBar" | "SparkRing" | "Category" | "Button">;
...
declare class DataTable extends Component {
    constructor(options: IDataTableOptions, componentType?: string);
}
export { DataTable };
