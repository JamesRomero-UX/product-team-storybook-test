const r = {
  ...
  inner: "0px 5px 2px 0px rgba(28, 32, 36, 0.01) inset, 0px 3px 2px 0px rgba(28, 32, 36, 0.03) inset, 0px 1px 1px 0px rgba(28, 32, 36, 0.05) inset, 0px 0px 1px 0px rgba(28, 32, 36, 0.06) inset",
  1: "0px 5px 2px 0px rgba(28, 32, 36, 0.01), 0px 3px 2px 0px rgba(28, 32, 36, 0.03), 0px 1px 1px 0px rgba(28, 32, 36, 0.05), 0px 0px 1px 0px rgba(28, 32, 36, 0.06)",
  2: "0px 16px 7px 0px rgba(28, 32, 36, 0.01), 0px 9px 6px 0px rgba(28, 32, 36, 0.03), 0px 4px 4px 0px rgba(28, 32, 36, 0.05), 0px 1px 2px 0px rgba(28, 32, 36, 0.06)",
  3: "0px 29px 12px 0px rgba(28, 32, 36, 0.01), 0px 16px 10px 0px rgba(28, 32, 36, 0.03), 0px 7px 7px 0px rgba(28, 32, 36, 0.05), 0px 2px 4px 0px rgba(28, 32, 36, 0.06)"
}, l = {
  px: "1px",
  0: "0px",
  "0_5": "0.125rem",
