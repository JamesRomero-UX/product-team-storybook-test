...
const parseViewDefinition_1 = __importDefault(require("./parseViewDefinition"));
(0, vitest_1.describe)("parseViewDefinition", () => {
    (0, vitest_1.it)("should understand a trivial select", async () => {
        const query = `SELECT id FROM service`;
        const def = await (0, parseViewDefinition_1.default)(query, "public");
    ...
    (0, vitest_1.it)("should understand a select with explicit schema", async () => {
    ...
    (0, vitest_1.it)("should understand a select with join", async () => {
   ...
   FROM service
    ...
    (0, vitest_1.it)("should work with multiple schemas and with aliases", async () => {
        const query = `
    ...
    (0, vitest_1.it)("should return undefined for unresolvable columns", async () => {
        const query = `
  SELECT cu.customer_id AS id,
   ...
   FROM customer cu
    ...
    (0, vitest_1.it)("should work with a minimalistic WITH clause", async () => {
        const query = `
    ...
    (0, vitest_1.it)("should resolve kanel#481", async () => {
        const query = `
    WITH RECURSIVE hierarchy_cte AS (
      SELECT posting.date,
         account.name AS account,
    ...
    (0, vitest_1.describe)("nested CTEs", () => {
        (0, vitest_1.it)("should resolve columns through nested CTE chain and preserve schema", async () => {
    ...
    (0, vitest_1.describe)("VALUES clause CTEs", () => {
        (0, vitest_1.it)("should handle VALUES-based CTE with undefined source", async () => {
            const query = `
        WITH inline_data AS (
    ...
    (0, vitest_1.describe)("UNION operations", () => {
        (0, vitest_1.it)("should resolve different aliases per UNION branch", async () => {
      ...
      `;
        ...
        (0, vitest_1.it)("should handle simple UNION ALL", async () => {
            const query = `
    ...
    (0, vitest_1.describe)("additional SQL features", () => {
        (0, vitest_1.it)("should handle DISTINCT ON", async () => {
            const query = `
      ...
      `;
        ...
        (0, vitest_1.it)("should handle subqueries in FROM clause", async () => {
            const query = `
