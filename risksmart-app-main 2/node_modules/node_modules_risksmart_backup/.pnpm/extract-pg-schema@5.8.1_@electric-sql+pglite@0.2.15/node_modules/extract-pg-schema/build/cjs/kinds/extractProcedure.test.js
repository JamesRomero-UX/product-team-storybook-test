...
const extractProcedure_1 = __importDefault(require("./extractProcedure"));
...
(0, vitest_1.describe)("extractProcedure", () => {
    const [getKnex] = (0, useTestKnex_1.default)();
    (0, useSchema_1.default)(getKnex, "test");
    (0, vitest_1.it)("should extract procedure details", async () => {
        const db = getKnex();
        await db.raw("create procedure test.some_procedure() as $$ begin end $$ language plpgsql");
        const result = await (0, extractProcedure_1.default)(db, makePgType("some_procedure"));
        const expected = {
            schemaName: "test",
            name: "some_procedure",
            kind: "procedure",
        ...
        (0, vitest_1.expect)(result).toMatchObject(expected);
    });
    (0, vitest_1.it)("should extract procedure details with parameters", async () => {
        const db = getKnex();
        await db.raw(`
