...
const fakeInformationSchemaColumnsQueryPart_1 = __importDefault(require("./query-parts/fakeInformationSchemaColumnsQueryPart"));
...
`;
const extractCompositeType = async (db, compositeType) => {
    const columnsQuery = await db.raw(`
    WITH 
    fake_info_schema_columns AS (
      ${fakeInformationSchemaColumnsQueryPart_1.default}
    ),
    type_map AS (
      ${typeMapQueryPart}
    ),
...
exports.default = extractCompositeType;
