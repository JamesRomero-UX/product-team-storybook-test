...
export function InternalItemsPalette({ items, renderItem, i18nStrings, __internalRootRef, ...rest }) {
    ...
    return (_jsxs("div", { ref: __internalRootRef, ...getDataAttributes(rest), children: [_jsx("div", { ref: paletteRef, className: styles.root, children: _jsx(ColumnLayout, { columns: 3, children: items.map((item) => (_jsx(ItemContainer, { ref: (elem) => {
                            if (elem) {
