...
import * as MessageTypesAPI from "./message-types.mjs";
import { APIPromise } from "../core/api-promise.mjs";
import { EntriesCursor, type EntriesCursorParams, PagePromise } from "../core/pagination.mjs";
import { RequestOptions } from "../internal/request-options.mjs";
export declare class MessageTypes extends APIResource {
    /**
...
export declare namespace MessageTypeTextField {
    /**
     * Settings for the text field.
     */
    interface Settings {
...
export interface MessageTypeVariant {
     ...
     */
    fields: Array<MessageTypeVariant.MessageTypeBooleanField | MessageTypeVariant.MessageTypeButtonField | MessageTypeVariant.MessageTypeImageField | MessageTypeVariant.MessageTypeMarkdownField | MessageTypeVariant.MessageTypeMultiSelectField | MessageTypeVariant.MessageTypeSelectField | MessageTypeTextField | MessageTypeVariant.MessageTypeTextareaField | MessageTypeVariant.MessageTypeURLField>;
    /**
...
export declare namespace MessageTypeVariant {
    /**
     * A boolean field used in a message type.
     */
    interface MessageTypeBooleanField {
        /**
         * The unique key of the field.
         */
        key: string;
    ...
    namespace MessageTypeBooleanField {
        /**
         * Settings for the boolean field.
         */
        interface Settings {
     ...
     */
    interface MessageTypeButtonField {
        /**
         * A text field used in a message type.
         */
    ...
    namespace MessageTypeButtonField {
        /**
         * Settings for the button field.
         */
        interface Settings {
     ...
     */
    interface MessageTypeImageField {
        /**
         * A text field used in a message type.
         */
        action: MessageTypesAPI.MessageTypeTextField;
    ...
    namespace MessageTypeImageField {
        /**
         * A URL field used in a message type.
         */
        interface URL {
     ...
     */
    interface MessageTypeMarkdownField {
        /**
         * The unique key of the field.
         */
        key: string;
    ...
    namespace MessageTypeMarkdownField {
        /**
         * Settings for the markdown field.
         */
        interface Settings {
     ...
     */
    interface MessageTypeMultiSelectField {
        /**
         * The unique key of the field.
         */
        key: string;
    ...
    namespace MessageTypeMultiSelectField {
        /**
         * Settings for the multi_select field.
         */
        interface Settings {
     ...
     */
    interface MessageTypeSelectField {
        /**
         * The unique key of the field.
         */
        key: string;
    ...
    namespace MessageTypeSelectField {
        /**
         * Settings for the select field.
         */
        interface Settings {
     ...
     */
    interface MessageTypeTextareaField {
        /**
         * The unique key of the field.
         */
        key: string;
    ...
    namespace MessageTypeTextareaField {
        /**
         * Settings for the textarea field.
         */
        interface Settings {
...
export declare namespace MessageTypeUpsertParams {
    /**
...
export declare namespace MessageTypeValidateParams {
    /**
     * A request to create a message type.
     */
    interface MessageType {
