...
import * as WorkflowsAPI from "./workflows.js";
import * as ChannelsAPI from "../channels.js";
import * as TemplatesAPI from "../templates.js";
import * as StepsAPI from "./steps.js";
import { StepPreviewTemplateParams, StepPreviewTemplateResponse, Steps } from "./steps.js";
...
export declare class Workflows extends APIResource {
     ...
     * ```
     */
    retrieve(workflowKey: string, query: WorkflowRetrieveParams, options?: RequestOptions): APIPromise<Workflow>;
    /**
...
export interface Condition {
     ...
     */
    operator: 'equal_to' | 'not_equal_to' | 'greater_than' | 'less_than' | 'greater_than_or_equal_to' | 'less_than_or_equal_to' | 'contains' | 'not_contains' | 'contains_all' | 'empty' | 'not_empty' | 'is_audience_member' | 'is_not_audience_member';
    /**
...
export declare namespace ConditionGroup {
     ...
     */
    interface ConditionGroupAllMatch {
        /**
     ...
     */
    interface ConditionGroupAnyMatch {
        /**
    ...
    namespace ConditionGroupAnyMatch {
        /**
         * A group of conditions that must all be met.
         */
        interface ConditionGroupAllMatch {
...
export declare namespace WorkflowBatchStep {
    /**
     * The settings for the batch step.
     */
    interface Settings {
...
export declare namespace WorkflowBranchStep {
    /**
...
export interface WorkflowChannelStep {
     ...
     */
    template: TemplatesAPI.EmailTemplate | TemplatesAPI.InAppFeedTemplate | TemplatesAPI.SMSTemplate | TemplatesAPI.PushTemplate | TemplatesAPI.ChatTemplate | TemplatesAPI.WebhookTemplate;
    /**
     * The type of the workflow step.
     */
    type: 'channel';
     ...
     */
    channel_overrides?: ChannelsAPI.EmailChannelSettings | ChannelsAPI.InAppFeedChannelSettings | ChannelsAPI.SMSChannelSettings | ChannelsAPI.PushChannelSettings | ChannelsAPI.ChatChannelSettings | null;
    /**
     * A group of conditions to be evaluated.
     */
    conditions?: ConditionGroup | null;
...
export declare namespace WorkflowDelayStep {
    /**
     * The settings for the delay step. Both fields can be set to compute a delay where
     * `delay_for` is an offset from the `delay_until_field_path`.
     */
 ...
 * `conditions`).
 */
export type WorkflowStep = WorkflowChannelStep | WorkflowDelayStep | WorkflowBatchStep | WorkflowFetchStep | WorkflowThrottleStep | WorkflowBranchStep | WorkflowTriggerWorkflowStep;
/**
...
export declare namespace WorkflowThrottleStep {
    /**
     * The settings for the throttle step.
     */
    interface Settings {
...
export declare namespace WorkflowTriggerWorkflowStep {
    /**
     * The settings for the workflow trigger workflow step.
     */
    interface Settings {
...
export declare namespace WorkflowRunParams {
     ...
     * An object reference.
     */
    interface ObjectRecipientReference {
        /**
...
export declare namespace WorkflowUpsertParams {
    /**
...
export declare namespace WorkflowValidateParams {
    /**
     * A workflow request for upserting a workflow.
     */
    interface Workflow {
...
export declare namespace Workflows {
    ...
    export { Steps as Steps, type StepPreviewTemplateResponse as StepPreviewTemplateResponse, type StepPreviewTemplateParams as StepPreviewTemplateParams, };
}
