...
export interface EmailTemplate {
     ...
     * provided.
     */
    visual_blocks?: Array<EmailTemplate.EmailButtonSetBlock | EmailTemplate.EmailDividerBlock | EmailTemplate.EmailHTMLBlock | EmailTemplate.EmailImageBlock | EmailTemplate.EmailMarkdownBlock | EmailTemplate.EmailPartialBlock>;
}
...
export declare namespace InAppFeedTemplate {
    /**
...
export declare namespace PushTemplate {
    /**
     * The [settings](https://docs.knock.app/integrations/sms/settings-and-overrides)
     * for the push template. Can be omitted.
     */
...
export declare namespace RequestTemplate {
...
export declare namespace WebhookTemplate {
    interface Header {
        /**
         * The key of the header.
         */
...
export declare namespace Templates {
    export { type ChatTemplate as ChatTemplate, type EmailTemplate as EmailTemplate, type InAppFeedTemplate as InAppFeedTemplate, type PushTemplate as PushTemplate, type RequestTemplate as RequestTemplate, type SMSTemplate as SMSTemplate, type WebhookTemplate as WebhookTemplate, };
}
