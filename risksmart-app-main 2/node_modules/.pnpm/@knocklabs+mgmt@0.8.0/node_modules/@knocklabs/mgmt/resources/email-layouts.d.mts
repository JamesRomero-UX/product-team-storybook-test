...
export declare class EmailLayouts extends APIResource {
    /**
...
export declare namespace EmailLayout {
...
export declare namespace EmailLayoutUpsertParams {
    /**
...
export declare namespace EmailLayoutValidateParams {
    /**
     * A request to update or create an email layout.
     */
    interface EmailLayout {
