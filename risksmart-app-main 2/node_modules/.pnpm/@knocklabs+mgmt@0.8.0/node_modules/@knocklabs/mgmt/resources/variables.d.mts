...
export declare class Variables extends APIResource {
    /**
...
export declare namespace Variables {
    export { type Variable as Variable, type VariablesEntriesCursor as VariablesEntriesCursor, type VariableListParams as VariableListParams, };
}
