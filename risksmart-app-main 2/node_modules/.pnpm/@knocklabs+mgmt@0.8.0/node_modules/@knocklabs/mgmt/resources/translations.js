...
class Translations extends resource_1.APIResource {
     ...
     * ```
     */
    retrieve(localeCode, query, options) {
        return this._client.get((0, path_1.path) `/v1/translations/${localeCode}`, { query, ...options });
    }
    /**
     ...
     */
    list(query, options) {
        return this._client.getAPIList('/v1/translations', (pagination_1.EntriesCursor), { query, ...options });
    }
    /**
     ...
     * ```
     */
    upsert(localeCode, params, options) {
        const { environment, namespace, annotate, commit, commit_message, format, ...body } = params;
        return this._client.put((0, path_1.path) `/v1/translations/${localeCode}`, {
     ...
     * ```
     */
    validate(localeCode, params, options) {
        const { environment, ...body } = params;
        return this._client.put((0, path_1.path) `/v1/translations/${localeCode}/validate`, {
            query: { environment },
            body,
            ...options,
        });
