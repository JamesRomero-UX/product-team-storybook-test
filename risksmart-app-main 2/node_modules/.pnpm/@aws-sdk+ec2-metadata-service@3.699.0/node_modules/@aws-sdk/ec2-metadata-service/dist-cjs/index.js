  ...
  constructor(options = {}) {
    this.config = (async () => {
      ...
      return {
        ...
        httpOptions: {
          timeout: ((_a = options == null ? void 0 : options.httpOptions) == null ? void 0 : _a.timeout) || 0
        },
        ec2MetadataV1Disabled: (options == null ? void 0 : options.ec2MetadataV1Disabled) ?? await (0, import_node_config_provider.loadConfig)(IMDSv1_DISABLED_SELECTORS, { profile })()
      };
    })();
