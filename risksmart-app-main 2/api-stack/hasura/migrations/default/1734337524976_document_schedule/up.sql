...
SELECT ca."Id",
    ...
    ca."Action"
FROM risksmart.document_audit ca
...
ALTER TABLE risksmart.document DROP COLUMN "LatestRatingDate";

ALTER TABLE risksmart.document_audit DROP COLUMN "LatestRatingDate";

ALTER TABLE risksmart.document DROP COLUMN "TestFrequency";

ALTER TABLE risksmart.document_audit DROP COLUMN "TestFrequency";

ALTER TABLE risksmart.document DROP COLUMN "NextTestDate";

ALTER TABLE risksmart.document_audit DROP COLUMN "NextTestDate";
