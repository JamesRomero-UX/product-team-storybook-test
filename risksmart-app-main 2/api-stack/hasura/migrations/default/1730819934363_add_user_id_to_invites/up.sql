...
ALTER TABLE risksmart.questionnaire_invite ADD COLUMN "UserId" text REFERENCES auth.user("Id");
ALTER TABLE risksmart.questionnaire_invite_audit ADD COLUMN "UserId" text;
