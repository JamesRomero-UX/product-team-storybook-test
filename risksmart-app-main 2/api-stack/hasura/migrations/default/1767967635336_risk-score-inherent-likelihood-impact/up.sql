...
ADD COLUMN "InherentImpact" float NULL;

ALTER TABLE risksmart."risk_score"
ADD COLUMN "InherentLikelihood" float NULL;
...
set "InherentImpact" = x."Impact",
    "InherentLikelihood" = x."Likelihood",
