import{g as i}from"./iframe-CGUFCU7f.js";function l(r,n){for(var c=0;c<n.length;c++){const e=n[c];if(typeof e!="string"&&!Array.isArray(e)){for(const o in e)if(o!=="default"&&!(o in r)){const a=Object.getOwnPropertyDescriptor(e,o);a&&Object.defineProperty(r,o,a.get?a:{enumerable:!0,get:()=>e[o]})}}}return Object.freeze(Object.defineProperty(r,Symbol.toStringTag,{value:"Module"}))}var d={exports:{}},_;function u(){return _||(_=1,(function(r,n){ace.define("ace/theme/cloud_editor_dark-css",["require","exports","module"],function(c,e,o){o.exports=`
...
`}),ace.define("ace/theme/cloud_editor_dark",["require","exports","module","ace/theme/cloud_editor_dark-css","ace/lib/dom"],function(c,e,o){e.isDark=!0,e.cssClass="ace-cloud_editor_dark",e.cssText=c("./cloud_editor_dark-css"),e.$showGutterCursorMarker=!0;var a=c("../lib/dom");a.importCssString(e.cssText,e.cssClass,!1)}),(function(){ace.require(["ace/theme/cloud_editor_dark"],function(c){r&&(r.exports=c)})})()})(d)),d.exports}var t=u();const k=i(t),b=l({__proto__:null,default:k},[t]);export{b as t};
